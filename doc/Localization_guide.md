...
The purpose of this guide is to describe how to contribute to the Creality Print translations. We use GNUgettext for extracting string resources from the project and PoEdit for editing translations.
...
1. Get PO-file 'CrealityPrint_xx.pot' from corresponding sub-folder here:
https://github.com/softfever/CrealityPrint/tree/master/localization/i18n
2. Open this file in PoEdit as "Edit a translation"
3. Apply your corrections to the translation
4. Push changed CrealityPrint_xx.po into the original folder
5. copy CrealityPrint_xx.mo into resources/i18n/xx and rename it to CrealityPrint.mo, then push the changed file.

### Scenario 2. How do I add a new language support
1. Get file CrealityPrint.pot here :
https://github.com/softfever/CrealityPrint/tree/master/localization/i18n
2. Open it in PoEdit for "Create new translation"
3. Select Translation Language (for example French).
4. As a result you will have fr.po - the file containing translation to French.
Notice. When the translation is complete you need to:
    - Rename the file to CrealityPrint_fr.po
    - Click "Save file" button. CrealityPrint_fr.mo will be created immediately
    - Bambu_Studio_fr.po needs to be copied into the sub-folder fr of https://github.com/softfever/CrealityPrint/tree/master/localization/i18n, and be pushed
	- copy CrealityPrint_xx.mo into resources/i18n/xx and rename it to CrealityPrint.mo, then push the changed file.
( name of folder "fr" means "French" - the translation language). 

### Scenario 3. How do I add a new text resource when implementing a feature to Creality Print
Each string resource in Creality Print available for translation needs to be explicitly marked using L() macro like this:
```C++
...
### Scenario 4. How do I use GNUgettext to localize my own application taking Creality Print as an example

1.  For convenience create a list of files with this macro `L(s)`. We have 
https://github.com/softfever/CrealityPrint/blob/master/localization/i18n/list.txt.

2.  Create template file(*.POT) with GNUgettext command:
    ```
        xgettext --keyword=L --add-comments=TRN --from-code=UTF-8 --debug -o CrealityPrint.pot -f list.txt
    ```
...
## General guidelines for Creality Print translators
...
- To check how the translated text looks on the UI elements, test it :) If you use *PoEdit*, all you need to do is save the file. At this point, a MO file will be created. Rename it Creality Print.mo, and you can run Creality Print (see above).

- If you see an encoding error (garbage characters instead of Unicode) somewhere in Creality Print, report it. It is likely not a problem of your translation, but a bug in the software.
