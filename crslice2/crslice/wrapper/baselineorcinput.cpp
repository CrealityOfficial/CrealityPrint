...
void BaselineOrcaInput::_BuildEntityModel(nlohmann::json& json_model, const Slic3r::Model& model)
{
    ...
    //    _BuildObjectGroup(json_model[BLName_Val(wipe_tower)][BLName_Val(positions)], model.wipe_tower.positions, _BuildEntityVec2d);
    //    // double                     rotation
    //    json_model[BLName_Val(wipe_tower)][BLName_Val(rotation)] = model.wipe_tower.rotation;
    //}
    //// std::map<size_t, ExtruderParams> extruderParamsMap;
    //_BuildObjectMap(json_model[BLName_Val(extruderParamsMap)], model.extruderParamsMap,
    //    [](nlohmann::json& json_object, const Slic3r::ExtruderParams& param)
    //    {
    //        // std::string materialName
    //        json_object[BLName_Val(materialName)] = param.materialName;
    //        // int bedTemp
    //        json_object[BLName_Val(bedTemp)] = param.bedTemp;
    //        // double heatEndTemp
    //        json_object[BLName_Val(heatEndTemp)] = param.heatEndTemp;
    //    });
    //// GlobalSpeedMap printSpeedMap;
    //{
    //    // double perimeterSpeed
    //    json_model[BLName_Val(print_speed)][BLName_Val(perimeterSpeed)] = model.printSpeedMap.perimeterSpeed;
    //    // double externalPerimeterSpeed
    //    json_model[BLName_Val(print_speed)][BLName_Val(externalPerimeterSpeed)] = model.printSpeedMap.externalPerimeterSpeed;
    //    // double infillSpeed
    //    json_model[BLName_Val(print_speed)][BLName_Val(infillSpeed)] = model.printSpeedMap.infillSpeed;
    //    // double solidInfillSpeed
    //    json_model[BLName_Val(print_speed)][BLName_Val(solidInfillSpeed)] = model.printSpeedMap.solidInfillSpeed;
    //    // double topSolidInfillSpeed
    //    json_model[BLName_Val(print_speed)][BLName_Val(topSolidInfillSpeed)] = model.printSpeedMap.topSolidInfillSpeed;
    //    // double supportSpeed
    //    json_model[BLName_Val(print_speed)][BLName_Val(supportSpeed)] = model.printSpeedMap.supportSpeed;
    //    // double smallPerimeterSpeed
    //    json_model[BLName_Val(print_speed)][BLName_Val(smallPerimeterSpeed)] = model.printSpeedMap.smallPerimeterSpeed;
    //    // double maxSpeed
    //    json_model[BLName_Val(print_speed)][BLName_Val(maxSpeed)] = model.printSpeedMap.maxSpeed;
    //    // Polygon bed_poly
    //    _BuildEntityPolygon(json_model[BLName_Val(print_speed)][BLName_Val(bed_poly)], model.printSpeedMap.bed_poly);
    //}
    //// std::string stl_design_id;
    //json_model[BLName_Val(stl_design_id)] = model.stl_design_id;
    //// std::shared_ptr<ModelDesignInfo> design_info
    //_BuildObjectSharedPtr(json_model[BLName_Val(design_info)], model.design_info,
    //    [](nlohmann::json& json_design_info, const Slic3r::ModelDesignInfo& design_info)
    //    {
    //        // std::string DesignId
    //        json_design_info[BLName_Val(DesignId)] = design_info.DesignId;
    //        // std::string Designer
    //        json_design_info[BLName_Val(Designer)] = design_info.Designer;
    //        // std::string DesignerUserId
    //        json_design_info[BLName_Val(DesignerUserId)] = design_info.DesignerUserId;
    //    });
    //// std::shared_ptr<ModelInfo> model_info
    //_BuildObjectSharedPtr(json_model[BLName_Val(model_info)], model.model_info,
    //    [](nlohmann::json& json_model_info, const Slic3r::ModelInfo& model_info)
    //    {
    //        // std::string cover_file
    //        json_model_info[BLName_Val(cover_file)] = model_info.cover_file;
    //        // std::string license
    //        json_model_info[BLName_Val(license)] = model_info.license;
    //        // std::string description
    //        json_model_info[BLName_Val(description)] = model_info.description;
    //        // std::string copyright
    //        json_model_info[BLName_Val(copyright)] = model_info.copyright;
    //        // std::string model_name
    //        json_model_info[BLName_Val(model_name)] = model_info.model_name;
    //        // std::string origin
    //        json_model_info[BLName_Val(origin)] = model_info.origin;
    //        // std::map<std::string, std::string> metadata_items
    //        _BuildObjectMap(json_model_info[BLName_Val(metadata_items)], model_info.metadata_items);
    //    });
    //// std::shared_ptr<ModelProfileInfo> profile_info
    //_BuildObjectSharedPtr(json_model[BLName_Val(profile_info)], model.profile_info,
    //    [](nlohmann::json& json_profile_info, const Slic3r::ModelProfileInfo& profile_info)
    //    {
    //        // std::string ProfileTile
    //        json_profile_info[BLName_Val(cover_file)] = profile_info.ProfileTile;
    //        // std::string ProfileCover
    //        json_profile_info[BLName_Val(ProfileCover)] = profile_info.ProfileCover;
    //        // std::string ProfileDescription
    //        json_profile_info[BLName_Val(ProfileDescription)] = profile_info.ProfileDescription;
    //        // std::string ProfileUserId
    //        json_profile_info[BLName_Val(ProfileUserId)] = profile_info.ProfileUserId;
    //        // std::string ProfileUserName
    //        json_profile_info[BLName_Val(ProfileUserName)] = profile_info.ProfileUserName;
    //    });
    //// int curr_plate_index
    //json_model[BLName_Val(curr_plate_index)] = model.curr_plate_index;
    //// std::map<int, CustomGCode::Info> plates_custom_gcodes
    //_BuildObjectMap(json_model[BLName_Val(plates_custom_gcodes)], model.plates_custom_gcodes,
    //    [](nlohmann::json& json_plates_custom_gcode, const Slic3r::CustomGCode::Info& info)
    //    {
    //        // Mode mode
    //        json_plates_custom_gcode[BLName_Val(mode)] = info.mode;
    //        // std::vector<Item> gcodes
    //        _BuildObjectGroup(json_plates_custom_gcode[BLName_Val(gcodes)], info.gcodes,
    //            [](nlohmann::json& json_gcode, const Slic3r::CustomGCode::Item& gcode)
    //            {
    //                // double      print_z
    //                json_gcode[BLName_Val(print_z)] = gcode.print_z;
    //                // Type        type
    //                json_gcode[BLName_Val(type)] = gcode.type;
    //                // int         extruder
    //                json_gcode[BLName_Val(extruder)] = gcode.extruder;
    //                // std::string color
    //                json_gcode[BLName_Val(color)] = gcode.color;
    //                // std::string extra
    //                json_gcode[BLName_Val(extra)] = gcode.extra;
    //            });
    //    });
    //// std::unique_ptr<CalibPressureAdvancePattern> calib_pa_pattern
    //_BuildObjectUniquePtr(json_model[BLName_Val(calib_pa_pattern)], model.calib_pa_pattern,
    //    [](nlohmann::json& json_calib_pa_pattern, const Slic3r::CalibPressureAdvancePattern& calib_pa_pattern)
    //    {
    //        //const double m_handle_xy_size
    //        json_calib_pa_pattern[BLName_Val(handle_xy_size)] = calib_pa_pattern.handle_xy_size();
    //        // const double m_handle_spacing
    //        json_calib_pa_pattern[BLName_Val(handle_spacing)] = calib_pa_pattern.handle_spacing();
    //        // print_size_x
    //        json_calib_pa_pattern[BLName_Val(print_size_x)] = calib_pa_pattern.print_size_x();
    //        // print_size_y
    //        json_calib_pa_pattern[BLName_Val(print_size_y)] = calib_pa_pattern.print_size_y();
    //        // max_layer_z
    //        json_calib_pa_pattern[BLName_Val(max_layer_z)] = calib_pa_pattern.max_layer_z();
    //        // Vec3d              m_starting_point
    //        _BuildEntityVec3d(json_calib_pa_pattern[BLName_Val(start_offset)], const_cast<Slic3r::CalibPressureAdvancePattern&>(calib_pa_pattern).get_start_offset());
    //    });
    //// std::string backup_path TODO
    //// std::map<int, int> object_backup_id_map TODO
}
...
bool BaselineOrcaInput::_CompareEntityModel(const nlohmann::json& json_model, const Slic3r::Model& model, BaseLineLogger& log)
{
    ...
    //// ModelWipeTower    wipe_tower;
    //err &= _CompareObject(json_model, BLName_Val(wipe_tower), model.wipe_tower, log,
    //    [](const nlohmann::json& json_wipe_tower, const Slic3r::ModelWipeTower& wipe_tower, BaseLineLogger& log)
    //    {
    //        bool err = true;
    //        // std::vector<Vec2d>      positions
    //        err &= _CompareObjectGroup(json_wipe_tower, BLName_Val(positions), wipe_tower.positions, log, _CompareEntityVec2d);
    //        // double                     rotation
    //        err &= _CompareObject(json_wipe_tower, BLName_Val(rotation), wipe_tower.rotation, log);

    //        BLReturnBoolen(err);
    //    });
    //// std::map<size_t, ExtruderParams> extruderParamsMap;
    //err &= _CompareObjectMap(json_model, BLName_Val(extruderParamsMap), model.extruderParamsMap, log,
    //    [](const nlohmann::json& json_object, const Slic3r::ExtruderParams& param, BaseLineLogger& log)
    //    {
    //        bool err = true;
    //        // std::string materialName
    //        err &= _CompareObject(json_object, BLName_Val(materialName), param.materialName, log);
    //        // int bedTemp
    //        err &= _CompareObject(json_object, BLName_Val(bedTemp), param.bedTemp, log);
    //        // double heatEndTemp
    //        err &= _CompareObject(json_object, BLName_Val(heatEndTemp), param.heatEndTemp, log);

    //        BLReturnBoolen(err);
    //    });
    //// GlobalSpeedMap printSpeedMap;
    //err &= _CompareObject(json_model, BLName_Val(printSpeedMap), model.printSpeedMap, log,
    //    [](const nlohmann::json& json_object, const Slic3r::GlobalSpeedMap& printSpeedMap, BaseLineLogger& log)
    //    {
    //        bool err = true;
    //        // double perimeterSpeed
    //        err &= _CompareObject(json_object, BLName_Val(perimeterSpeed), printSpeedMap.perimeterSpeed, log);
    //        // double externalPerimeterSpeed
    //        err &= _CompareObject(json_object, BLName_Val(externalPerimeterSpeed), printSpeedMap.externalPerimeterSpeed, log);
    //        // double infillSpeed
    //        err &= _CompareObject(json_object, BLName_Val(infillSpeed), printSpeedMap.infillSpeed, log);
    //        // double solidInfillSpeed
    //        err &= _CompareObject(json_object, BLName_Val(solidInfillSpeed), printSpeedMap.solidInfillSpeed, log);
    //        // double topSolidInfillSpeed
    //        err &= _CompareObject(json_object, BLName_Val(topSolidInfillSpeed), printSpeedMap.topSolidInfillSpeed, log);
    //        // double supportSpeed
    //        err &= _CompareObject(json_object, BLName_Val(supportSpeed), printSpeedMap.supportSpeed, log);
    //        // double smallPerimeterSpeed
    //        err &= _CompareObject(json_object, BLName_Val(smallPerimeterSpeed), printSpeedMap.smallPerimeterSpeed, log);
    //        // double maxSpeed
    //        err &= _CompareObject(json_object, BLName_Val(maxSpeed), printSpeedMap.maxSpeed, log);
    //        // Polygon bed_poly
    //        err &= _CompareObject(json_object, BLName_Val(bed_poly), printSpeedMap.bed_poly, log, _CompareEntityPolygon);

    //        BLReturnBoolen(err);
    //    });
    //// std::string stl_design_id;
    //err &= _CompareObject(json_model, BLName_Val(stl_design_id), model.stl_design_id, log);
    //// std::shared_ptr<ModelDesignInfo> design_info
    //err &= _CompareObjectSharedPtr(json_model, BLName_Val(design_info), model.design_info, log, 
    //    [](const nlohmann::json& json_object, const Slic3r::ModelDesignInfo& design_info, BaseLineLogger& log)
    //    {
    //        bool err = true;
    //        // std::string DesignId
    //        err &= _CompareObject(json_object, BLName_Val(DesignId), design_info.DesignId, log);
    //        // std::string Designer
    //        err &= _CompareObject(json_object, BLName_Val(Designer), design_info.Designer, log);
    //        // std::string DesignerUserId
    //        err &= _CompareObject(json_object, BLName_Val(DesignerUserId), design_info.DesignerUserId, log);

    //        BLReturnBoolen(err);
    //    });
    //// std::shared_ptr<ModelInfo> model_info
    //err &= _CompareObjectSharedPtr(json_model, BLName_Val(model_info), model.model_info, log,
    //    [](const nlohmann::json& json_object, const Slic3r::ModelInfo& model_info, BaseLineLogger& log)
    //    {
    //        bool err = true;
    //        // std::string cover_file
    //        err &= _CompareObject(json_object, BLName_Val(cover_file), model_info.cover_file, log);
    //        // std::string license
    //        err &= _CompareObject(json_object, BLName_Val(license), model_info.license, log);
    //        // std::string description
    //        err &= _CompareObject(json_object, BLName_Val(description), model_info.description, log);
    //        // std::string copyright
    //        err &= _CompareObject(json_object, BLName_Val(copyright), model_info.copyright, log);
    //        // std::string model_name
    //        err &= _CompareObject(json_object, BLName_Val(model_name), model_info.model_name, log);
    //        // std::string origin
    //        err &= _CompareObject(json_object, BLName_Val(origin), model_info.origin, log);
    //        // std::map<std::string, std::string> metadata_items
    //        err = _CompareObjectMap(json_object, BLName_Val(metadata_items), model_info.metadata_items, log);

    //        BLReturnBoolen(err);
    //    });
    //// std::shared_ptr<ModelProfileInfo> profile_info
    //err &= _CompareObjectSharedPtr(json_model, BLName_Val(profile_info), model.profile_info, log,
    //    [](const nlohmann::json& json_object, const Slic3r::ModelProfileInfo& profile_info, BaseLineLogger& log)
    //    {
    //        bool err = true;
    //        // std::string ProfileTile
    //        err &= _CompareObject(json_object, BLName_Val(ProfileTile), profile_info.ProfileTile, log);
    //        // std::string ProfileCover
    //        err &= _CompareObject(json_object, BLName_Val(ProfileCover), profile_info.ProfileCover, log);
    //        // std::string ProfileDescription
    //        err &= _CompareObject(json_object, BLName_Val(ProfileDescription), profile_info.ProfileDescription, log);
    //        // std::string ProfileUserId
    //        err &= _CompareObject(json_object, BLName_Val(ProfileUserId), profile_info.ProfileUserId, log);
    //        // std::string ProfileUserName
    //        err &= _CompareObject(json_object, BLName_Val(ProfileUserName), profile_info.ProfileUserName, log);

    //        BLReturnBoolen(err);
    //    });
    //// int curr_plate_index
    //err &= _CompareObject(json_model, BLName_Val(curr_plate_index), model.curr_plate_index, log);
    //// std::map<int, CustomGCode::Info> plates_custom_gcodes
    //err &= _CompareObjectMap(json_model, BLName_Val(plates_custom_gcodes), model.plates_custom_gcodes, log,
    //    [](const nlohmann::json& json_object, const Slic3r::CustomGCode::Info& info, BaseLineLogger& log)
    //    {
    //        bool err = true;
    //        // Mode mode
    //        err &= _CompareObject(json_object, BLName_Val(mode), info.mode, log);
    //        // std::vector<Item> gcodes
    //        err &= _CompareObjectGroup(json_object, BLName_Val(gcodes), info.gcodes, log,
    //            [](const nlohmann::json& json_object, const Slic3r::CustomGCode::Item& gcode, BaseLineLogger& log)
    //            {
    //                bool err = true;
    //                // double      print_z
    //                err &= _CompareObject(json_object, BLName_Val(print_z), gcode.print_z, log);
    //                // Type        type
    //                err &= _CompareObject(json_object, BLName_Val(type), gcode.type, log);
    //                // int         extruder
    //                err &= _CompareObject(json_object, BLName_Val(extruder), gcode.extruder, log);
    //                // std::string color
    //                err &= _CompareObject(json_object, BLName_Val(color), gcode.color, log);
    //                // std::string extra
    //                err &= _CompareObject(json_object, BLName_Val(extra), gcode.extra, log);
    ...
    //    });
    //// std::unique_ptr<CalibPressureAdvancePattern> calib_pa_pattern
    //err &= _CompareObjectUniquePtr(json_model, BLName_Val(calib_pa_pattern), model.calib_pa_pattern, log,
    //    [](const nlohmann::json& json_calib_pa_pattern, const Slic3r::CalibPressureAdvancePattern& calib_pa_pattern, BaseLineLogger& log)
    //    {
    //        bool err = true;
    //        //const double m_handle_xy_size
    //        err &= _CompareObject(json_calib_pa_pattern, BLName_Val(handle_xy_size), calib_pa_pattern.handle_xy_size(), log);
    //        // const double m_handle_spacing
    //        err &= _CompareObject(json_calib_pa_pattern, BLName_Val(handle_spacing), calib_pa_pattern.handle_spacing(), log);
    //        // print_size_x
    //        err &= _CompareObject(json_calib_pa_pattern, BLName_Val(print_size_x), calib_pa_pattern.print_size_x(), log);
    //        // print_size_y
    //        err &= _CompareObject(json_calib_pa_pattern, BLName_Val(print_size_y), calib_pa_pattern.print_size_y(), log);
    //        // max_layer_z
    //        err &= _CompareObject(json_calib_pa_pattern, BLName_Val(max_layer_z), calib_pa_pattern.max_layer_z(), log);
    //        // Vec3d              m_starting_point
    //        err &= _CompareObject(json_calib_pa_pattern, BLName_Val(m_starting_point), const_cast<Slic3r::CalibPressureAdvancePattern&>(calib_pa_pattern).get_start_offset(), log, _CompareEntityVec3d);
...
bool BaselineOrcaInput::_CompareEntityFacetsAnnotation(const nlohmann::json& json_object, const Slic3r::FacetsAnnotation& facets, BaseLineLogger& log)
{
    ...
    auto& support_facets = facets.get_data();
    if (json_object.size() != support_facets.first.size())
    {
