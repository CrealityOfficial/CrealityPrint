...
public:
  ...
  void place_seam(const Layer *layer, ExtrusionLoop &loop, bool external_first, const Point &last_pos, float& overhang,float seam_slope_min_length,bool is_seam_slope_gap) const;
private:
