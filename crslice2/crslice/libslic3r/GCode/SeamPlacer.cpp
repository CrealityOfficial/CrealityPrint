...
#include <SVG.hpp>
#define value_to_rgbf(x, y, z) Vec3f(x, y, z)
#define value_to_rgbi(x, y, z) Vec3i((int)(x * 255.0f), (int)(y * 255.0f), (int)(z * 255.0f))
#endif
