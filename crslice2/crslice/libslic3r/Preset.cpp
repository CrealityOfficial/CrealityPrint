...
static std::vector<std::string> s_Preset_print_options {
    ...
    "flush_into_infill", "flush_into_objects", "flush_into_support",
     ...
     "gcode_add_line_number", "enable_arc_fitting","arc_tolerance", "infill_combination", /*"adaptive_layer_height",*/
...
static std::vector<std::string> s_Preset_filament_options {
    /*"filament_colour", */ "default_filament_colour","default_filament_type","required_nozzle_HRC","filament_diameter", "filament_type", "filament_soluble", "filament_is_support",
    "filament_max_volumetric_speed",
    "filament_flow_ratio", "filament_density", "filament_cost", "filament_minimal_purge_on_wipe_tower",
    "nozzle_temperature", "nozzle_temperature_initial_layer",
    // BBS
    "cool_plate_temp", "eng_plate_temp", "hot_plate_temp", "textured_plate_temp", "cool_plate_temp_initial_layer", "eng_plate_temp_initial_layer", "hot_plate_temp_initial_layer","textured_plate_temp_initial_layer","epoxy_resin_plate_temp","epoxy_resin_plate_temp_initial_layer",
    // "bed_type",
