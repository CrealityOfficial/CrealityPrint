...
QQC2.ApplicationWindow {
    id: standaloneWindow
    flags : Qt.platform.os !== "osx" ? Qt.FramelessWindowHint | Qt.Window | Qt.WindowMinimizeButtonHint
                                     : Qt.Window | Qt.WindowFullScreen | Qt.WindowFullscreenButtonHint
    ...
    DockContext {
        ...
        tabBarY: Qt.platform.os !== "osx" ? standaloneWindow.y + idMenuBar.height + topToolBar.height + 1
        : standaloneWindow.y + topToolBar.height + 1
        ...
        adsorbedItemHeight: Qt.platform.os !== "osx" ? standaloneWindow.height - idMenuBar.height - topToolBar.height - tabBarHeight - 2
        : standaloneWindow.height- topToolBar.height - tabBarHeight - 2
    }
            ...
            MacMenu.Menu {
                ...
                MacMenu.Menu{
                    ...
                    Instantiator {
                        ...
                        onObjectAdded: __fileHistory.insertItem(index, object)
                ...
                MacMenu.Menu{
                    ...
                    Instantiator {
                        ...
                        onObjectAdded: __projectHistory.insertItem(index, object)
    ...
    ResizeItem {
        ...
        Connections {
            ...
            onSupportStructureRequired: {
                //                tipsItem.addMsgTip("The model has not been supported and may fail to print. Do you want to continue adding supports before slicing?", "Add Support", "")
        ...
        Item{
            ...
            GLQuickItem{
                ...
                opacity	: (kernel_kernel.currentPhase != 2 && kernel_parameter_manager.functionType == 0) ? 1.0 : 0.0
                        ...
                        Image {
                            ...
                            MouseArea{
                                ...
                                onPositionChanged: {
                                    ...
                                    if(wrapperRec.height < 500 * screenScaleFactor) return
                                    else if(wrapperRec.height > 838 * screenScaleFactor) return
        ...
        QQC25.Control{
            id: topToolBar
            width: parent.width
            height: Qt.platform.os == "osx" ? 90  * screenScaleFactor : 60  * screenScaleFactor
            anchors.top: depRec.bottom
            anchors.horizontalCenter: parent.horizontalCenter
            background:Rectangle{
                opacity: 1.0
                gradient: Gradient {
                    GradientStop {  position: 0.0;    color: Constants.topToolBarColor  }
            ...
            Item{
                ...
                Row{
                    ...
                    CusButton{
                        ...
                        txtColor : isChecked ? Constants.topBtnTextColor_checked
                                             : isHovered ? Constants.topBtnTextColor_hovered
        ...
        StackLayout {
                ...
                delegate: Item {
                    ...
                    CusButton {
                        ...
                        Connections {
                            ...
                            {
                                if (model.index !== 1) return
                                sliceBtnsModel.set(1, { "isEnabled": idLaserView.enableGenerate })
                            }
                        }
                        Connections {
                            ...
                            onEnableGenerateChanged:
                            {
                                if (model.index !== 2) return
                                sliceBtnsModel.set(2, { "isEnabled": idPlotterView.enableGenerate })
                            }
                        }
                    }
                }
            ...
            onTempSliceEnableChanged: sliceBtnsModel.set(0, { "isEnabled": kernel_modelspace.modelNNum > 0 ? true : false })
        }
    ...
    ModelAlwaysShowPopupDlg {
        ...
        Connections {
            ...
            onLoadRecommendModelGroupListSuccessed: function(json_string, page_index) {
                enabled = false
                if (kernel_ui.firstStart) { return }
                if (!kernel_global_const.cxcloudEnabled) { return }
    ...
    ModelLibraryInfoDlg {
        ...
        onVisibleChanged:{
            if(visible){
                var curLang = kernel_global_const.readRegister("profile_setting/service_type")
