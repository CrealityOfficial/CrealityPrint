...
Item {
    ...
    property int sliceType: {
        if (kernel_slice_flow.isPreviewGCodeFile) {
            ...
            return ((kernel_slice_flow.isSlicing ||
                    kernel_printer_manager.selectedPrinter.canSlice) &&
    ...
    signal exportButtonClicked(var type)

    function clickSliceButton() {
        slice_button.focus = true;
        Qt.callLater(function() {
            startSlice();
        })
        //slice_button.clicked();
    }
                    ...
                    CusRoundedBg {
                        ...
                        MouseArea {
                            ...
                            onClicked: {
                                ...
                                if (!btnGroupBox.setEnble) return ;
                                startSlice();
    ...
    Rectangle {
        ...
        property bool hasSlicedPlate:  kernel_slice_flow.isPreviewGCodeFile || kernel_printer_manager.hasPrinterSliced
        ...
        ListModel {
            ...
            ListElement {
                textId: qsTr("Print Plate")
                type: 0
            }

            ListElement {
                textId: qsTr("Print All")
                type: 1
            }

            ListElement {
                textId: qsTr("Export Plate")
                type: 2
            }
            ListElement {
                textId: qsTr("Export Plate Sliced File")
                type: 3
            }
            ListElement {
                textId: qsTr("Upload")
        ...
        Column {
                ...
                contentItem:Column {
                    Repeater {
                        ...
                        delegate: CusRoundedBg {
                            ...
                            leftBottom:model.index ===printData.count - 1
                            rightBottom:model.index === printData.count - 1
                            width: 150 * screenScaleFactor
                            height: 36 * screenScaleFactor
                            radius:10 * screenScaleFactor
                            borderWidth:0
                            ...
                            BasicTooltip{
                                id: sliceBtn
                                text: qsTr("The current printer model doesn't support multi-plate printing and can't export.")
                                visible: parent.isHover && model.index === 3 && !kernel_parameter_manager.currentMachineObject.inheritBaseName.includes("F008")
                            }
                            ...
                            MouseArea {
                                ...
                                cursorShape: containsMouse ? Qt.PointingHandCursor : Qt.ArrowCursor
                                onClicked: {
                                    if(model.index === 3 && !kernel_parameter_manager.currentMachineObject.inheritBaseName.includes("F008")){
                                        return;
                                    }
                                    ...
                                    exportButtonClicked(model.type);
            ...
            Rectangle {
                ...
                color: {
                    ...
                    switch (selPrint.type) {
                    case 1:
                    case 3:
                        btnEnabled = printMenu.hasSlicedPlate
                        break;
                    default:
                        btnEnabled = printMenu.setEnble
                    }

                    console.log("22222222 = ", parent.type)
                    return  btnEnabled ? Constants.themeGreenColor : Constants.currentTheme ? "#ffffff" : "#59595D"
                }
                border.color: Constants.currentTheme ? "#CECECF" : "transparent"
                border.width: 0
                radius: 5
                ...
                MouseArea {
                    ...
                    onClicked: {
                        ...
                        exportButtonClicked(parent.type);
                    }
                }
