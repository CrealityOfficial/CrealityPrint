...
MacMenu.MenuBar {
    ...
    MacMenu.Menu {
        ...
        MacMenu.Menu {
            ...
            title: qsTranslate("CWinMenu", "Recently files")
    ...
    MacMenu.Menu {
        ...
        MacMenu.MenuItem {
            text: qsTranslate("CWinMenu", "Clear All")
    ...
    MacMenu.Menu {
        ...
        MacMenu.MenuItem {
            text: qsTranslate("CWinMenu", "Manage Materials")
            enabled: controlEnabled && isFDMPrinter
            onTriggered: {
    ...
    MacMenu.Menu {
        ...
        title: qsTranslate("CWinMenu", "Models(&M)")
        enabled: isFDMPrinter

        MacMenu.MenuItem {
            text: qsTranslate("CWinMenu", "Models")
            enabled: controlEnabled && isFDMPrinter
            shortcut : "Alt+M"
            onTriggered: {
                excuteOpt("Models");
    ...
    MacMenu.Menu {
        ...
        MacMenu.MenuItem {
            text: qsTranslate("CWinMenu","Retraction test")
            enabled: controlEnabled && isFDMPrinter
