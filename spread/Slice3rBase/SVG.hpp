...
public:
    ...
    void draw(const Clipper3r::Path  &polygon, double scale, std::string fill = "grey", coordf_t stroke_width = 0);
    void draw(const Clipper3r::Paths &polygons, double scale, std::string fill = "grey", coordf_t stroke_width = 0);
    ...
    std::string get_path_d(const Clipper3r::Path &mp, double scale, bool closed = false) const;
