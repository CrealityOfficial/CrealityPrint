...
if(WINDOWSSDK_FOUND)
	...
	function(get_winsdk_vers _winsdk_dir _var)
		file(GLOB children RELATIVE ${_winsdk_dir} ${_winsdk_dir}/*)
		set(dirlist "")
		foreach(child ${children})
			if(IS_DIRECTORY ${_winsdk_dir}/${child})
	...
	function(get_latest_windowssdk _winsdk_dir _var)
		get_winsdk_vers(${_winsdk_dir}/Include/ _win_vers)
		list(REVERSE _win_vers)
		message(STATUS "sdk vers ${_winsdk_dir} -> ${_win_vers}")
		foreach(_ver ${_win_vers})
			set(${_var} ${_winsdk_dir}/Include/${_ver} PARENT_SCOPE)
			break()
		endforeach()
	endfunction()
	function(get_windowssdk_include_dirs_all _winsdk_dir _var)
		set(_dirs)
