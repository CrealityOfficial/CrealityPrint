...
if(NOT TARGET boost_iostreams)	
	set(boost_iostreams_INCLUDE_DIRS ${BOOST_INCLUDE_DIRS}/)
	set(boost_iostreams_LIBRARIES_DEBUG ${BOOST_INSTALL_ROOT}/lib/libboost_iostreams.a)
	set(boost_iostreams_LIBRARIES_RELEASE ${BOOST_INSTALL_ROOT}/lib/libboost_iostreams.a)
