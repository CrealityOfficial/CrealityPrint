...
if(PYCXX_FOUND)
	...
	#to relative
	set(PYCXX_SOURCES_T)
	foreach(item IN LISTS PYCXX_SOURCES)
		string(REPLACE "${PYCXX_INCLUDE_DIR}/" "" RELATIVE_PYCXX "${item}")
		message(STATUS "PYCXX ${item} --> ${RELATIVE_PYCXX}")
		list(APPEND PYCXX_SOURCES_T ${RELATIVE_PYCXX})
	endforeach()
	set(PYCXX_SOURCES ${PYCXX_SOURCES_T})
else(PYCXX_FOUND)
    MESSAGE(STATUS "PyCXX not found")
endif(PYCXX_FOUND)
