...
SET(PROJECT_ICONS_DIRECTORY "${CMAKE_SOURCE_DIR}/customized/Piocreat/icon")
set(LICENSE_FILE "customized/Piocreat/license.rtf")
set(LICENSE_FILE_EN "customized/Piocreat/license_en.rtf")
set(LICENSE_FILE_TD "customized/Piocreat/license.rtf")
...
IF(CC_BC_WIN)
  ...
  IF(DEFINED MATERIAL_LIST)
    message(STATUS "custom material list src:" ${MATERIAL_LIST})
    message(STATUS "custom material list dst:" ${CMAKE_SOURCE_DIR}/resources/sliceconfig/default/Materials/materials_custom.json)
    configure_file(${MATERIAL_LIST} ${CMAKE_SOURCE_DIR}/resources/sliceconfig/default/Materials/materials_custom.json)
  ENDIF()


  IF(DEFINED PROFILE_KEY)
    message(STATUS "custom PROFILE_KEY src:" ${PROFILE_KEY})
    message(STATUS "custom PROFILE_KEY dst:" ${CMAKE_SOURCE_DIR}/resources/sliceconfig/default/Profiles/keys_custom)
    configure_file(${PROFILE_KEY} ${CMAKE_SOURCE_DIR}/resources/sliceconfig/default/Profiles/keys_custom)
  ENDIF()

  IF(DEFINED PROFILE_KEY_SHELL)
    message(STATUS "custom PROFILE_KEY_SHELL src:" ${PROFILE_KEY_SHELL})
    message(STATUS "custom PROFILE_KEY_SHELL dst:" ${CMAKE_SOURCE_DIR}/resources/sliceconfig/default/Profiles/keys-shell_custom)
    configure_file(${PROFILE_KEY_SHELL} ${CMAKE_SOURCE_DIR}/resources/sliceconfig/default/Profiles/keys-shell_custom)
  ENDIF()
  ...
  LIST(APPEND CPACK_NSIS_EXTRA_INSTALL_COMMANDS "CreateDirectory $APPDATA\\\\Piocreat")
  LIST(APPEND CPACK_NSIS_EXTRA_INSTALL_COMMANDS "CreateDirectory $APPDATA\\\\Piocreat\\\\${PROJECT_NAME}")
  LIST(APPEND CPACK_NSIS_EXTRA_INSTALL_COMMANDS "CreateDirectory $APPDATA\\\\Piocreat\\\\${PROJECT_NAME}\\\\resources")
...
ELSEIF(CC_BC_MAC)
  include(${CMAKE_SOURCE_DIR}/customized/Piocreat/macx.cmake)
