...
install(CODE "execute_process(COMMAND bash  ${CMAKE_SOURCE_DIR}/customized/Piocreat/macx/Notarized-script.sh \${CMAKE_INSTALL_PREFIX} ${PROJECT_NAME} $ENV{MACPASS})")

set(CPACK_GENERATOR "DragNDrop")
set(CPACK_PACKAGE_FILE_NAME "${BUNDLE_NAME}-${PROJECT_VERSION}")
set(CPACK_DMG_VOLUME_NAME ${DESKTOP_LINK_NAME})
set(CPACK_DMG_BACKGROUND_IMAGE "${CMAKE_SOURCE_DIR}/customized/Piocreat/macx/CMakeDMGBackground.tif")
set(CPACK_PACKAGE_ICON "${CMAKE_SOURCE_DIR}/customized/Piocreat/macx/VolumeIcon.icns")
set(CPACK_DMG_DS_STORE_SETUP_SCRIPT "${CMAKE_SOURCE_DIR}/customized/Piocreat/macx/CMakeDMGSetup.scpt")
