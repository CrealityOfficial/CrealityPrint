...
public:
  explicit DownloadModelRequest(const QString& group_id,
                                const QString& model_id,
                                const QString& name,
                                std::weak_ptr<boost::asio::thread_pool> thread_pool =
                                  std::shared_ptr<boost::asio::thread_pool>{ nullptr },
...
protected:
  ...
  std::shared_ptr<boost::asio::thread_pool> thread_pool_shared_{ nullptr };
  std::weak_ptr<boost::asio::thread_pool> thread_pool_weak_{ thread_pool_shared_ };
};
