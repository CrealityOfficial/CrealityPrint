...
set (CPACK_PACKAGE_VERSION_EXTRA "${PROJECT_VERSION_EXTRA}")
set (CPACK_PACKAGE_FILE_NAME "${PROCESS_NAME}_${CREALITYPRINT_VERSION}_${PROJECT_VERSION_EXTRA}")
# Append architecture suffix so ARM64 packages are distinguishable from x64.
if ("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "ARM64" OR "${CMAKE_VS_PLATFORM_NAME}" STREQUAL "ARM64" OR "${CMAKE_GENERATOR_PLATFORM}" STREQUAL "ARM64")
    set (CPACK_PACKAGE_FILE_NAME "${CPACK_PACKAGE_FILE_NAME}_arm64")
endif ()
...
set (CPACK_PACKAGE_INSTALL_REGISTRY_KEY "CrealityPrint-${CREALITYPRINT_VERSION_MAJOR}")
...
set(CPACK_NSIS_COMPRESSOR "/SOLID off")
