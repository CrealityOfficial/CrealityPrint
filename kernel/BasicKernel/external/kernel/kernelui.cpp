...
void KernelUI::loadUserSettings()
{
    ...
    if (strStartType == "0")
    {
        ...
        if(USE_LOCAL_PARAM_PACKAGE)
        {
            setting.setValue("sync_official_param","0");
            setting.setValue("auto_check_profile_updateable",false);
            
        }else{
            setting.setValue("sync_official_param","1");
            setting.setValue("auto_check_profile_updateable",true);
        }
        setting.endGroup();
...
bool KernelUI::pasteEnable()
{
    return canPasteEnabled();
}
...
QColor KernelUI::showColorDialog(QColor oldcolor, QObject* parent)
{
    ...
    int curLanguage = currentLanguage();
    LANGID langid;
    switch (MultiLanguage(curLanguage))
    {
    case MultiLanguage::eLanguage_EN_TS:
        langid = MAKELANGID(LANG_ENGLISH, SUBLANG_ENGLISH_UK);
        break;
    case MultiLanguage::eLanguage_ZHCN_TS:
        langid = MAKELANGID(LANG_CHINESE_SIMPLIFIED, SUBLANG_CHINESE_SIMPLIFIED);
        break;
    case MultiLanguage::eLanguage_ZHTW_TS:
        langid = MAKELANGID(LANG_CHINESE_TRADITIONAL, SUBLANG_CHINESE_TRADITIONAL);
        break;
    case MultiLanguage::eLanguage_JA_TS:
        langid = MAKELANGID(LANG_JAPANESE, SUBLANG_JAPANESE_JAPAN);
        break;
    case MultiLanguage::eLanguage_KO_TS:
        langid = MAKELANGID(LANG_KOREAN, SUBLANG_KOREAN);
        break;
    case MultiLanguage::eLanguage_UK_TS:
        langid = MAKELANGID(LANG_UKRAINIAN, SUBLANG_UKRAINIAN_UKRAINE);
        break;
    case MultiLanguage::eLanguage_RU_TS:
        langid = MAKELANGID(LANG_RUSSIAN, SUBLANG_RUSSIAN_RUSSIA);
        break;
    case MultiLanguage::eLanguage_FR_TS:
        langid = MAKELANGID(LANG_FRENCH, SUBLANG_FRENCH);
        break;
    case MultiLanguage::eLanguage_ES_TS:
        langid = MAKELANGID(LANG_SPANISH, SUBLANG_SPANISH_MEXICAN);
        break;
    case MultiLanguage::eLanguage_PT_TS:
        langid = MAKELANGID(LANG_PORTUGUESE, SUBLANG_PORTUGUESE);
        break;
    case MultiLanguage::eLanguage_TR_TS:
