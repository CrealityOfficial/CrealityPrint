...
namespace creative_kernel
{
	...
	{
		return FLT_MAX != builder.baseInfo.minAcc ? builder.baseInfo.minAcc : 0.0f;
	}

	float SliceAttain::maxAcc()
	{
		return FLT_MIN != builder.baseInfo.maxAcc ? builder.baseInfo.maxAcc : 0.0f;
	}
	...
	{
		colorList = builder.getGCodeStruct().m_nozzleColorList;
		defaultColorList = builder.getGCodeStruct().m_nozzleColorListDefault;
		defaultType = builder.getGCodeStruct().m_nozzleTypeDefault;
	}
