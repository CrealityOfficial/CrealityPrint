...
#include "internal/parameter/materialLinkageModel.h"
namespace creative_kernel
{
    ...
    class ParameterManager : public QObject
    {
        ...
        Q_PROPERTY(QObject* materialLinkageModel READ materialLinkageModelObject CONSTANT);
    ...
    public:
        ...
        MaterialLinkageModel* materialLinkageModel();
        ...
        Q_INVOKABLE QString currentMachineBaseName();
        ...
        void loadProjectSettings(const QString& filename,std::vector<float>& wipe_tower_x,std::vector<float>& wipe_tower_y);
    ...
    private:
        ...
        Q_SLOT void onCurrentProfileChanged();

        Q_SLOT void onExtruderAdded(QObject* extruder);
        Q_SLOT void onExtruderRemoved(QObject* extruder);
        Q_SLOT void onExtruderColorChanged();
    ...
    private:
        ...
        MaterialLinkageModel* m_MaterialLinkageModel = nullptr;
