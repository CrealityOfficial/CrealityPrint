var LangText = {
  en: {
    t1: "Welcome to Creality Print",
    t2: "Creality Print will be setup in several steps. Let's start!",
    t3: "User Agreement",
    t4: "Disagree",
    t5: "Agree",
    ...
    t52: "Skip",
    t53: "Join",
    t54: "In the 3D Printing community, we learn from each other's successes and failures to adjust our own slicing parameters and settings. Creality Print follows the same principle and uses machine learning to improve its performance from the successes and failures of the vast number of prints by our users. We are training Creality Print to be smarter by feeding them the real-world data. If you are willing, this service will access information from your error logs and usage logs, which may include information described in ",
    t55: "Privacy Policy",
    ...
    t65: "Please be aware that these plugins are not developed or maintained by CrealityPrint. They should be used at your own discretion and risk.",
    ...
    t83: "2, Close all open Creality Print",
    t84: "3, Delete all files under the plug-in directory",
    t85: "4, Reopen Creality Print and install the plug-in again",
    t86: "Close",
    t87: "User Manual",
    t88: "Remove",
    ...
    creality1: "Edit Project Info",
    creality2: "no model information",
    creality3: "Please select at least one printer.",
    // 添加打印机区域多语言 
    ...
    t126: "All",
    t127: "Search Results",
    t128: "The model you want is not found. Please search again."
    
  },
    ca_ES: {
    t1: "Benvingut a Creality Print",
    t2: "Creality Print es configurarà en diversos passos. Comencem!",
    ...
    t52: "Saltar",
    t53: "Unir-se",
    t54: "A la comunitat d'Impressió 3D, aprenem dels èxits i fracassos dels altres per ajustar els nostres propis paràmetres i configuracions de laminació. Creality Print segueix el mateix principi i utilitza l'aprenentatge automàtic per millorar el seu rendiment a partir dels èxits i fracassos d'un gran nombre d'impressions dels nostres usuaris. Estem entrenant Creality Print per ser més intel·ligent alimentant-lo amb dades del món real. Si estàs disposat, aquest servei accedirà a informació dels teus registres d'errors i registres d'ús, que poden incloure informació descrita a la ",
    ...
    t65: "Tingues en compte que aquests connectors no són desenvolupats ni mantinguts per CrealityPrint. S'han d'utilitzar a la teva discreció i risc.",
    ...
    t83: "2, Tanca totes les Creality Print obertes",
    t84: "3, Elimina tots els fitxers del directori de connectors",
    t85: "4, Reobre Creality Print i instal·la el connector de nou",
    t86: "Tancar",
    ...
    creality1: "Editar Informació del Projecte",
    creality2: "no hi ha informació del model",

    t114: "sistema",
    t115: "usuari",
    t116: "Si us plau, entreu",
    t117: "Diàmetre del forat del broquet",
    t118: "Seleccioneu-ho tot",
    t119: "marca",
    t120: "model",
    t121: "Nom de la configuració",
    t129: "mida",
    t122: "Diàmetre del broquet",
    t123: "Tipus de firmware",
    t124: "Segur",
    t125: "Cancel·la",
    t126: "tots"
},
  es_ES: {
    t1: "Bienvenido a Creality Print",
    t2: "Va a configurar Creality Print mediante varios pasos. ¡Vamos a comenzar!",
    ...
    t52: "Saltar",
    t53: "Ingresar",
    t54: "En la comunidad de impresión 3D, pordemos aprender de los logros y los fallos de otros para obtener nuestros propios parametros y configuraciones de Creality Print follows the same principle and uses machine learning to improve its performance from the successes and failures of the vast number of prints by our users. We are training Creality Print to be smarter by feeding them the real-world data. If you are willing, this service will access information from your error logs and usage logs, which may include information described in ",
    ...
    t83: "2, Cerrar todos los Creality Print abiertos",
    t84: "3, Borrar todos los archivos en el directorio de complementos",
    t85: "4, Reabrir Creality Print e instalar el complemento de nuevo",
    t86: "Cerrar",
    ...
    t114: "sistema",
    t115: "usuario",
    t116: "Por favor ingresa",
    t117: "Diámetro del orificio de la boquilla",
    t118: "Seleccionar todo",
    t119: "marca",
    t120: "modelo",
    t121: "Nombre de configuración",
    t129: "tamaño",
    t129: "Diámetro de la boquilla",
    t123: "Tipo de firmware",
    t124: "Seguro",
    t125: "Cancelar",
    t126: "todo"
  },
  de_DE: {
    t1: "Willkommen im Creality Print",
    t2: "Das Creality Print wird in mehreren Schritten eingerichtet. Lass uns anfangen!",
    ...
    t52: "Überspringen",
    t53: "Beitreten",
    t54: "In der 3D-Druck-Community lernen wir aus den Erfolgen und Misserfolgen der anderen Benutzer, um unsere eigenen Schneideparameter und Einstellungen anzupassen. Creality Print folgt demselben Prinzip und verbessert seine Leistung durch die Erfolge und Misserfolge der Vielzahl von Drucken unserer Benutzer mittels maschinellem Lernen. Wir trainieren Creality Print, indem wir ihnen die realen Daten zuführen. Wenn Sie bereit sind, greift dieser Dienst auf Informationen aus Ihren Fehler- und Nutzungsprotokollen zu, die Informationen enthalten können, die in der ",
    ...
    t83: "2, Schließen Sie alle geöffneten Creality Print",
    t84: "3, Löschen Sie alle Dateien im Plug-in-Verzeichnis",
    t85: "4, Öffnen Sie Creality Print erneut und installieren Sie das Plug-in erneut",
    t86: "Schließen",
    ...
    t114: "System",
    t115: "Benutzer",
    t116: "Bitte treten Sie ein",
    t117: "Düsenlochdurchmesser",
    t118: "Alles auswählen",
    t119: "Marke",
    t120: "Modell",
    t121: "Konfigurationsname",
    t129: "Größe",
    t122: "Düsendurchmesser",
    t123: "Firmware-Typ",
    t124: "Sicher",
    t125: "Stornieren",
    t126: "alle"
  ...
  cs_CZ: {
    t1: "Vítejte v Creality Print",
    t2: "Creality Print bude nastaven v několika krocích. Začněme!",
    ...
    t52: "Přeskočit",
    t53: "Připojit se",
    t54: "V komunitě 3D tisku se ze vzájemných úspěchů a neúspěchů učíme upravovat vlastní parametry a nastavení krájení. Creality Print se řídí stejným principem a využívá strojové učení ke zlepšení svého výkonu na základě úspěchů a neúspěchů počet výtisků našimi uživateli. Creality Print školíme, aby byl chytřejší tím, že jim poskytuje data z reálného světa. Pokud budete chtít, bude tato služba přistupovat k informacím z vašich protokolů chyb a protokolů použití, které mohou zahrnovat informace popsané v ",
    ...
    t83: "2, Zavřete všechny otevřené Creality Print",
    t84: "3, Smažte všechny soubory v adresáři plug-in",
    t85: "4, znovu otevřete Creality Print a znovu nainstalujte zásuvný modul",
    t86: "Zavřít",
    ...
    t115: "uživatel",
    t116: "Zadejte prosím",
    t117: "Průměr otvoru trysky",
    t118: "Vyberte vše",
    t119: "značka",
    t120: "model",
    t121: "Název konfigurace",
    t129: "velikost",
    t122: "Průměr trysky",
    t123: "Typ firmwaru",
    t124: "Jasně",
  ...
  fr_FR: {
    t1: "Bienvenue sur Creality Print",
    t2: "Creality Print sera configuré en plusieurs étapes. Commençons !",
    ...
    t52: "Passer",
    t53: "Rejoindre",
    t54: "Dans la communauté de l'impression 3D, nous apprenons des succès et des échecs des uns et des autres pour ajuster nos propres paramètres et paramètres de découpage. Creality Print suit le même principe et utilise l'apprentissage automatique pour améliorer ses performances à partir des succès et des échecs du grand nombre d'impressions de nos utilisateurs. Nous formons Creality Print à être plus intelligent en leur fournissant les données du monde réel. Si vous le souhaitez, ce service accédera aux informations de vos journaux d'erreurs et de vos journaux d'utilisation, qui peuvent inclure des informations décrites dans ",
    ...
    t65: "Veuillez noter que ces plugins ne sont pas développés ou maintenus par CrealityPrint. Ils doivent être utilisés à votre propre discrétion et à vos propres risques.",
    ...
    t83: "2, Fermez toutes les fenêtres de Creality Print",
    t84: "3, Supprimez tous les fichiers dans le répertoire du plug-in",
    t85: "4, Relancez Creality Print et réinstallez le plug-in.",
    t86: "Fermer",
    ...
    creality1: "Modifier les informations du projet",
    creality2: "pas d'information sur le modèle",
    wk1: "Démarrage rapide",
    wk2: "Cet article présente l'utilisation la plus basique de Creality Print. Il guide les utilisateurs pour configurer le logiciel, créer des projets et effectuer la première tâche d'impression étape par étape.",
    wk3: "Workflow basé sur des projets",
    wk4: "Creality Print met en avant un workflow de pointe pour véritablement réaliser un projet « tout en un ». Basé sur le format de projet 3MF grand public, il fournit une série de nouvelles fonctionnalités révolutionnaires, telles que la prise en charge de plusieurs plaques, un gestionnaire de ressources de projet et une vue d'assemblage/de pièce. Cela améliore considérablement l'efficacité des créateurs et des utilisateurs réguliers",
    wk5: "Impression haute vitesse de qualité",
    wk6: "Il est difficile d'imprimer à grande vitesse tout en maintenant une qualité élevée. Creality Print rend cela possible. « Arch Move » permet à la hotend de se déplacer en douceur et réduit les vibrations de la machine. Le refroidissement intelligent est basé sur des paramètres de refroidissement affinés pour chaque type de filament. Le « ralentissement automatique » pour les paroies en porte-à-faux permet d'éviter la déformation à grande vitesse.",
    wk7: "Impression multi-couleur",
    wk8: "Creality Print fournit des outils de colorisation polyvalents pour créer un modèle coloré. Vous pouvez librement ajouter/supprimer des filaments dans un projet et coloriser votre modèle avec différents pinceaux. Avant l'impression, chaque filament sera automatiquement mappé sur un emplacement AMS, sans avoir besoin de modifier manuellement le placement de la bobine dans l'AMS.",
    wk9: "Guide de réglage des paramètres de découpage",
    wk10: "Les fonctionnalités de gestion des paramètres de Creality Print offrent un contrôle très flexible et puissant sur le processus de découpage. Cet article présente l'organisation des paramètres et fournit quelques compétences pour tirer pleinement parti de ces fonctionnalités.",
    wk11: "Contrôle et surveillance à distance",
    wk12: "Creality Print prend en charge l'envoi du travail d'impression à votre imprimante via le réseau WAN/LAN, contrôlant et surveillant chaque aspect de votre imprimante 3D et des travaux d'impression. Si vous avez plusieurs imprimantes, vous pouvez facilement basculer entre elles dans la liste des périphériques.",
    wk13: "Format STEP",
    ...
    wk15: "Texte 3D",
    wk16: "Avec l'outil Texte 3D, les utilisateurs peuvent facilement créer diverses formes de texte 3D dans le projet, ce qui rend le modèle plus personnalisé. Creality Print fournit des dizaines de polices et prend en charge les styles gras et italique pour donner au texte une plus grande flexibilité.",
    t114: "système",
    t115: "utilisateur",
    t116: "Veuillez entrer",
    t117: "Diamètre du trou de buse",
    t118: "Tout sélectionner",
    t119: "marque",
    t120: "modèle",
    t121: "Nom de la configuration",
    t129: "taille",
    t122: "Diamètre de la buse",
    t123: "Type de micrologiciel",
    t124: "Bien sûr",
    t125: "Annuler",
    t126: "tous"
  },
  zh_CN: {
    t1: "欢迎使用Creality Print",
    t2: "Creality Print需要几步安装步骤，让我们开始吧！",
    t3: "用户使用协议",
    t4: "拒绝",
    t5: "同意",
    t6: "帮助提升Creality Print性能",
    t7: "允许发送匿名数据",
    t8: "上一步",
    t9: "下一步",
    t10: "选择打印机",
    ...
    t52: "忽略",
    t53: "同意",
    t54: "在3D打印社区，我们从彼此的成功和失败中学习调整自己的切片参数和设置。Creality Print遵循同样的原则，通过机器学习的方式从大量用户打印的成功和失败中获取经验，从而改善打印性能。我们正在通过向Creality Print提供真实世界的数据来训练他们变得更聪明。如果您愿意，此服务将访问您的错误日志和使用日志中的信息，其中可能包括",
    t55: "隐私政策",
    ...
    t64: "Bambu网络插件",
    t65: "注意：这些插件不是由CrealityPrint开发或维护的。使用它们需自担风险",
    t66: "强大的远程控制功能",
    t67: "实时视频流",
    t68: "用户数据同步",
    t69: "安装Bambu网络插件",
    ...
    t81: "1, 点击",
    t82: "打开插件所在目录",
    t83: "2, 关闭所有Creality Print",
    t84: "3, 删除插件所在目录下的所有文件",
    t85: "4, 重新启动Creality Print并尝试安装插件",
    t86: "关闭",
    t87: "使用引导",
    t88: "移除",
    t89: "打开所在的文件夹",
    ...
    t113: "您可以随时更改您的偏好。",
    wk1: "快速入门指南",
    wk2: "本文介绍了Creality Print的最基本用法。它指导用户配置软件，创建项目，并逐步完成第一个打印任务。",
    wk3: "基于项目的工作流",
    wk4: "Creality Print提出了领先的工作流程，真正实现了“一体化”项目。基于主流的3MF项目格式，它提供了一系列革命性的新功能，如支持多盘、项目资源管理器和装配/零件视图。它可以大幅提高模型创作者及普通用户的使用效率。",
    wk5: "质量卓越的高速打印",
    wk6: "在保持高质量的前提下进行高速打印是非常具有挑战性的。Creality Print让这一切发生。支持“圆弧移动”特性使工具头移动更加顺滑，有效减少机器振动。基于不同材料类型的精细标定过的冷却控制参数，使得冷却过程可以自动开展。在悬垂区域进行“自动减速”，可防止高速打印时在此区域的外观瑕疵。",
    wk7: "多色打印",
    wk8: "Creality Print提供了多种着色工具来制作彩色模型。您可以在项目中自由添加/移除打印材料，并使用不同的笔刷为模型着色。开始打印时，打印任务中的各个材料将自动映射到匹配的AMS槽位，无需手动调整AMS中的料卷位置。",
    wk9: "切片参数设置指南",
    wk10: "Creality Print中的参数管理功能为切片过程提供了非常灵活和强大的控制。本文介绍了切片参数的组织分类和设置方法，并提供了一些使用技巧。",
    wk11: "远程控制和监控",
    wk12: "Creality Print支持通过WAN/LAN网络向打印机发送打印任务，控制和查看3D打印机和打印任务的各个方面。如果您有多台打印机，还可以在设备列表中轻松切换。",
    wk13: "STEP格式",
    wk14: "与STL相比，STEP带来了更多有效的信息。由于STEP的高精度，切片时可以生成更多的圆弧路径。STEP还包括模型每个零件的装配关系，可分割模型后恢复装配视图。",
    wk15: "3D文本",
    wk16: "使用3D文本工具，用户可以轻松地在项目中创建各种3D文本形状，使模型更加个性化。Creality Print提供了数十种字体，并支持粗体和斜体样式，使文本具有更大的灵活性。",
    creality1: "编辑项目信息",
    creality2: "该模型没有相关信息",
    creality3: "请至少选择一款打印机",
    ...
    t126: "全部",
    t127: "搜索结果",
    t128: "没有搜索到您想要的机型，请重新搜索~"

  },
  zh_TW: {
    t1: "歡迎使用 Creality Print",
    t2: "Creality Print 需要幾步安裝步驟，讓我們開始吧！",
    t3: "使用者協議",
    t4: "拒絕",
    t5: "同意",
    t6: "幫助提升 Creality Print 性能",
    t7: "允許傳送匿名數據",
    t8: "上一步",
    t9: "下一步",
    t10: "選擇３Ｄ列印機",
    ...
    t52: "忽略",
    t53: "同意",
    t54: "在3D列印社區，我們從彼此的成功和失敗中學習調整自己的切片參數和設置。Creality Print 遵循同樣的原則，透過機器學習的方式從大量用戶列印的成功和失敗中獲取經驗，從而改善列印性能。我們正在通過向 Creality Print 提供真實世界的數據來訓練他們變得更聰明。如果您願意，此服務將訪問您的錯誤日誌和使用日誌中的資訊，其中可能包括",
    t55: "隱私政策",
    ...
    t81: "1, 點擊",
    t82: "打開插件所在目錄",
    t83: "2, 關閉所有 Creality Print",
    t84: "3, 刪除插件所在目錄下的所有文件",
    t85: "4, 重新啟動 Creality Print 並嘗試安裝插件",
    t86: "關閉",
    t87: "使用引導",
    t88: "移除",
    t89: "打開所在的文件夾",
    ...
    creality2: "no model information",
    wk1: "快速入門指南",
    wk2: "本文介紹了 Creality Print 的最基本用法。它指導用戶配置軟體，創建項目，並逐步完成第一個列印任務。",
    wk3: "基於項目的工作流",
    wk4: "Creality Print 提出了領先的工作流程，真正實現了“一體化”項目。基於主流的3MF項目格式，它提供了一系列革命性的新功能，如支持多盤、項目資源管理器和裝配/零件視圖。它可以大幅提高模型創作者及普通用戶的使用效率。",
    wk5: "質量卓越的高速列印",
    wk6: "在保持高品質的前提下進行高速列印是非常具有挑戰性的。Creality Print 讓這一切發生。支持“圓弧移動”特性使工具頭移動更加順滑，有效減少機器振動。基於不同線材類型的精細標定過的冷卻控制參數，使得冷卻過程可以自動開展。在懸垂區域進行“自動減速”，可防止高速列印時在此區域的外觀瑕疵。",
    wk7: "多色列印",
    wk8: "Creality Print 提供了多種著色工具來製作彩色模型。您可以在項目中自由添加/移除列印材料，並使用不同的筆刷為模型著色。開始列印時，列印任務中的各個線材將自動映射對應到 AMS 槽位，無需手動調整 AMS 中的線材位置。",
    wk9: "切片參數設置指南",
    wk10: "Creality Print 中的參數管理功能為切片過程提供了非常靈活和強大的控制。本文介紹了切片參數的組織分類和設置方法，並提供了一些使用技巧。",
    wk11: "遠端控制和監控",
    wk12: "Creality Print 支持透過無線網路/區域網路向３Ｄ列印機發送列印任務，控制和查看３Ｄ列印機和列印任務的各個方面。如果您有多台３Ｄ列印機，還可以在設備清單中輕鬆切換。",
    wk13: "STEP格式",
    wk14: "與 STL 相比，STEP 帶來了更多有效的資訊。由於 STEP 的高精度，切片時可以生成更多的圓弧路徑。STEP 還包括模型每個零件的組裝關係，可分割模型後恢復裝配視圖。",
    wk15: "３Ｄ文本",
    wk16: "使用３Ｄ文字工具，使用者可以輕鬆地在項目中建立各種３Ｄ文字形狀，使模型更加個性化。Creality Print 提供了數十種字體，並支援粗體和斜體樣式，使文字具有更大的靈活性。",
    creality3:"請至少選擇一款印表機",
    // 添加打印机区域多语言 
  ...
  ru_RU: {
    t1: "Приветствуем в Creality Print!",
    t2: "Для настройка Creality Print необходимо пройти несколько этапов. Давайте начнём!",
    ...
    t52: "Пропустить",
    t53: "Войти",
    t54: "В сообществе 3D-печатников для выявления наилучших параметров нарезки и улучшения печати мы учимся на успехах и неудачах друг друга. Creality Print следует тому же принципу и использует машинное обучение для улучшения своей работы на основе успешных и неудачных печатей наших пользователей. Мы обучаем Creality Print быть умнее на основе реальных данных. По вашему согласию эта служба получит доступ к вашим журналам ошибок и журналам использования, в которых содержатся сведения, описанные в ",
    ...
    t83: "2, Закрыть все открытые Creality Print",
    t84: "3, Удалить все файлы в папке плагина",
    t85: "4, Откройте Creality Print и снова установите подключаемый модуль.",
    t86: "Закрыть",
    t87: "Инструкции",
    t88: "Удалить",
    ...
    creality1: "Редактировать информацию о проекте",
    creality2: "Информации о модели отсутствует",
    t114: "система",
    t115: "пользователь",
    t116: "Пожалуйста, введите",
    t117: "Диаметр отверстия сопла",
    t118: "Выбрать все",
    t119: "бренд",
    t120: "модель",
    t121: "Имя конфигурации",
    t129: "размер",
    t122: "Диаметр сопла",
    t123: "Тип прошивки",
    t124: "Конечно",
  ...
  ja_JP: {
    ...
    t125: "キャンセル",
    t126: "全て",
    t130: "ご希望のモデルが見つかりませんでした。もう一度検索してください~",
  },
  ko_KR: {
    t1: "Creality Print에 오신 것을 환영합니다",
    t2: "Creality Print는 여러 단계로 설정됩니다. 시작!",
    t3: "사용자 약관",
    t4: "거부",
    t5: "동의",
    ...
    t52: "건너뛰기",
    t53: "가입",
    t54: "3D 프린팅 커뮤니티에서 우리는 각자의 슬라이싱 매개변수와 설정을 조정하는 과정에서 서로의 성공과 실패를 통해 배웁니다. Creality Print는 동일한 원칙을 따르며 기계 학습을 사용하여 사용자의 방대한 출력물의 성공과 실패를 통해 성능을 향상시킵니다. 우리는 실제 데이터를 제공하여 Creality Print가 더욱 똑똑해지도록 교육하고 있습니다. 귀하가 원할 경우 이 서비스는 오류 로그 및 사용 로그의 정보에 액세스합니다. 여기에는 다음에 설명된 정보가 포함될 수 있습니다.",
    t55: "개인 정보 정책",
    ...
    t83: "2, 열려 있는 모든 Creality Print를 닫습니다.",
    t84: "3, 플러그인 디렉터리 아래의 모든 파일 삭제합니다",
    t85: "4, Creality Print를 다시 열고 플러그인을 다시 설치하세요.",
    t86: "닫기",
    t87: "사용자 메뉴얼",
    t88: "제거",
    t89: "포함된 폴더 열기",
  ...
  tr_TR: {
    t1: "Creality Print'a hoş geldiniz",
    t2: "creality Dilimleyici birkaç adımda kurulacaktır. Hadi başlayalım!",
    ...
    t52: "Atla",
    t53: "Katıl",
    t54: "3D Baskı topluluğunda, kendi dilimleme parametrelerimizi ve ayarlarımızı düzenlerken birbirimizin başarılarından ve başarısızlıklarından öğreniyoruz. Creality Print da aynı prensibi takip ediyor ve kullanıcılarımızın yaptığı çok sayıda baskının başarı ve başarısızlıklarından performansını artırmak için makine öğrenimini kullanıyor. Creality Print'ı gerçek dünya verileriyle besleyerek daha akıllı olması için eğitiyoruz. İsterseniz bu hizmet, hata günlüklerinizden ve kullanım günlüklerinizden, burada açıklanan bilgileri de içerebilecek bilgilere erişecektir. ",
    ...
    t65: "Lütfen bu eklentilerin CrealityPrint tarafından geliştirilmediğini veya bakımının yapılmadığını unutmayın. Kendi takdirinize ve riskinize göre kullanılmalıdırlar.",
    ...
    t83: "2, Tüm açık Creality Printı kapatın",
    t84: "3, Eklenti dizini altındaki tüm dosyaları silin",
    t85: "4, Creality Print'ı yeniden açın ve eklentiyi tekrar yükleyin",
    t86: "Kapat",
    ...
    creality1: "Proje Bilgilerini Düzenle",
    creality2: "model bilgisi yok",
    t114: "sistem",
    t115: "kullanıcı",
    t116: "Lütfen girin",
    t117: "Meme deliği çapı",
    t118: "Tümünü seç",
    t119: "marka",
    t120: "modeli",
    t121: "Yapılandırma adı",
    t129: "boyut",
    t122: "Meme çapı",
    t123: "Firmware türü",
    t124: "Elbette",
  ...
  pl_PL: {
    t1: "Witamy w Creality Print",
    t2: "Creality Print zostanie skonfigurowany w kilku krokach. Zacznijmy!",
    ...
    t52: "Pomiń",
    t53: "Dołącz",
    t54: "W społeczności druku 3D uczymy się od sukcesów i porażek innych, aby dostosować nasze własne parametry i ustawienia krojenia. Creality Print podąża tą samą zasadą i wykorzystuje uczenie maszynowe do poprawy swojej wydajności na podstawie sukcesów i porażek dużej liczby wydruków naszych użytkowników. Szkolimy Creality Print, aby był mądrzejszy, dostarczając mu danych z rzeczywistego świata. Jeśli chcesz, ta usługa uzyska dostęp do informacji z Twoich logów błędów i logów użytkowania, które mogą zawierać informacje opisane w ",
    ...
    t65: "Proszę mieć świadomość, że te wtyczki nie są rozwijane ani utrzymywane przez CrealityPrint. Powinny być używane na własne ryzyko i z rozwagą.",
    ...
    t83: "2, Zamknij wszystkie otwarte Creality Print",
    t84: "3, Usuń wszystkie pliki z katalogu wtyczek",
    t85: "4, Ponownie otwórz Creality Print i zainstaluj wtyczkę ponownie",
    t86: "Zamknij",
    ...
    creality1: "Edytuj informacje o projekcie",
    creality2: "brak informacji o modelu",
    t114: "system",
    t115: "użytkownik",
    t116: "Proszę wejść",
    t117: "Średnica otworu dyszy",
    t118: "Zaznacz wszystko",
    t119: "marka",
    t120: "model",
    t121: "Nazwa konfiguracji",
    t129: "rozmiar",
    t122: "Średnica dyszy",
    t123: "Typ oprogramowania",
    t124: "Jasne",
    t125: "Anulować",
    t126: "Wszystko"
  },
  pt_BR: {
    t1: "Bem-vindo ao Creality Print",
    t2: "Creality Print será configurado em algumas etapas. Vamos começar!",
    t3: "Termos de Uso",
    t4: "Discordo",
    t5: "Concordo",
    ...
    t65: "Por favor seja cuidadoso estes plugins não são desenvolvidos ou mantidos por CrealityPrint. Eles devem ser usados por sua conta e risco.",
    ...
    t83: "2, Feche totalmente o Creality Print",
    t84: "3, Delete todos os arquivos na pasta do plug-in",
    t85: "4, Reabra o Creality Print e instale o plug-in novamente",
    t86: "Fechar",
    ...
    creality1: "Editar Info do Projeto",
    creality2: "Sem informação do modelo",
    t114: "sistema",
    t115: "utilizador",
    t116: "Por favor, insira",
    t117: "Diâmetro do furo do bico",
    t118: "Selecionar tudo",
    t119: "marca",
    t120: "modelo",
    t121: "Nome da configuração",
    t129: "tamanho",
    t122: "Diâmetro do bico",
    t123: "Tipo de firmware",
    t124: "Claro",
    t125: "Cancelar",
    t126: "todos"
...
function TranslatePage() {
  ...
  for (let n = 0; n < nTotal; n++) {
    ...
    if (LangText[strLang].hasOwnProperty(tid)) {
      ...
      $(OneNode).attr('placeholder', LangText[strLang][tid]);
    }
  }
}
