...
#include "Slice3rBase/PrintConfig.hpp"
//#include "Slice3rBase/ExtrusionRole.hpp"
...
namespace Slic3r {
    ...
    public:
        ...
        void setDebugger(crslice::PEDebugger* _debugger) { debugger = _debugger; }
    private:
        ...
        struct GCodeLine
        {
            ...
            float       volumetric_correction_avg() const {
                ...
                //std::cout << avg_correction << std::endl;
                return avg_correction;
            }
            float time_corrected() const
            {
                float xxxx = volumetric_correction_avg();
                //if (xxxx < 0.89999)
        ...
        crslice::PEDebugger* debugger = nullptr;
