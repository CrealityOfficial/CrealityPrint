    ...
    namespace GUI {
        ...
        namespace render
        {
            ...
            public:
                ...
                virtual const GLShaderProgram* get_shader() const = 0;
                virtual void update_uniform(const GLShaderProgram* p_shader);
            };
            ...
            public:
                ...
                const GLShaderProgram* get_shader() const override;

                void update_uniform(const GLShaderProgram* p_shader) override;
            public:
        ...
        //{
            ...
            protected:
                ...
                bool show_sequential_view() const;
            ...
            private:
                ...
                Extrusions::Range get_range_according_to_view_type(EViewType type) const;
