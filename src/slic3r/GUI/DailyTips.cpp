...
void DailyTipsDataRenderer::load_texture_from_img_url(const std::string url)
{
    ...
    if (!url.empty()) {
        ...
        m_texture->load_from_png_file(Slic3r::resources_dir() + "/" + url, true, GLTexture::None, false);
    }
    else {
        if (!m_placeholder_texture) {
            m_placeholder_texture = new GLTexture();
            m_placeholder_texture->load_from_png_file(Slic3r::resources_dir() + "/images/dailytips_placeholder.png", true, GLTexture::None, false);
        }
    }
}
...
void DailyTipsPanel::render_controller_buttons(const ImVec2& pos, const ImVec2& size)
{
    ...
    if (ImGui::BeginChild(name.c_str(), size, false, window_flags)) {
        ...
        // prev button
        ImColor button_text_color = m_is_dark ? ImColor(255, 255, 255, (int)(255 * m_fade_opacity)) : ImColor(38, 46, 48, (int)(255 * m_fade_opacity));
        ...
        {
            button_text_color = ImColor(150, 150, 155, (int)(255 * m_fade_opacity));
            if (ImGui::IsMouseClicked(ImGuiMouseButton_Left))
        ...
        // next button
        button_text_color = m_is_dark ? ImColor(255, 255, 255, (int)(255 * m_fade_opacity)) : ImColor(38, 46, 48, (int)(255 * m_fade_opacity));
