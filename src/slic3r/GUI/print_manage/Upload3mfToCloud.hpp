#ifndef slic3r_GUI_Upload3mfToCloud_hpp_
#define slic3r_GUI_Upload3mfToCloud_hpp_
...
class Upload3mfToCloudDialog : public DPIDialog
{
private:
	void init_bind();
	void init_timer();
    ...
    //wxBoxSizer                          m_panel_image{nullptr};
    ...
    wxStaticText*						m_stext_printer{ nullptr };
    wxStaticText*                       m_stext_material{nullptr};
    ...
    wxRadioButton*                       m_radio_upload_new;
    wxRadioButton*                       m_radio_upload_exit;
    wxStaticText*                        m_stext_process;
    wxBoxSizer*                          m_sizer_material;
    wxStaticText*                        m_stext_plate_count;
    wxStaticText*                        m_stext_plate_sliced_count;
    wxBoxSizer*                          m_sizer_thumbnail;
...
public:
    ...
    void on_upload_3mf(wxCommandEvent& event);
