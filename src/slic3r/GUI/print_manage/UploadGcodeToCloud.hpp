#ifndef slic3r_GUI_UploadGcodeToCloud_hpp_
#define slic3r_GUI_UploadGcodeToCloud_hpp_
...
class UploadGcodeToCloudDialog : public DPIDialog
{
private:
	void init_bind();
	void init_timer();
    ...
    wxStaticText*                       m_stext_printer2{nullptr};
    wxToolTip*                          m_stext_printer2_tip{nullptr};
...
private:
    UploadFile  m_upload_file;
    std::string m_ssGCodeFilePath;
    std::string m_printTime;
    std::string m_printWeight;
};
