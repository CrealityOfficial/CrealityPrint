...
void GLGizmoFdmSupports::on_render_input_window(float x, float y, float bottom_limit)
{
    ...
    for (int i = 0; i < tool_ids.size(); i++) {
        ...
        ImGui::PushStyleColor(ImGuiCol_Button, m_is_dark_mode ? ImVec4(0.43f, 0.43f, 0.447f, 1.f) : ImVec4(1.f, 1.f, 1.f, 1.f));	// ORCA use orca color for selected tool / brush
        ImGui::PushStyleColor(ImGuiCol_ButtonHovered, ImGuiWrapper::COL_CREALITY);	// ORCA use orca color for selected tool / brush
        ImGui::PushStyleColor(ImGuiCol_ButtonActive, ImGuiWrapper::COL_CREALITY);	// ORCA use orca color for selected tool / brush
    ...
    if (m_current_tool == ImGui::CircleButtonIcon) {
        ...
        cp_drag_float("##cursor_radius_input", &m_cursor_radius, 0.10f, CursorRadiusMin, CursorRadiusMax, "%.2f");
        ...
        cp_drag_float("##cursor_radius_input", &m_cursor_radius, 0.1f, CursorRadiusMin, CursorRadiusMax, "%.2f");
        ImGui::Dummy(ImVec2(0, 0));
        ...
        cp_drag_float("##smart_fill_angle_input", &m_smart_fill_angle, 1.0f, SmartFillAngleMin, SmartFillAngleMax, "%.2f");
        ImGui::Dummy(ImVec2(0,0));
        ...
        cp_drag_float("##gap_area_input", &TriangleSelectorPatch::gap_area, 0.1f, TriangleSelectorPatch::GapAreaMin,
                      TriangleSelectorPatch::GapAreaMax, "%.2f");
        ImGui::Dummy(ImVec2(0, 0));
    }
    ...
    cp_drag_float("##angle_threshold_deg_input", &m_highlight_by_angle_threshold_deg, 1.0f, 0.f, 90.f, "%.2f");
    ImGui::Dummy(ImVec2(0, 0)); 
    ...
    if (m_current_tool != ImGui::GapFillIcon) {
        ...
        bool b_drag_input = cp_drag_float("##clp_dist_input", &clp_dist, 0.05f, 0.f, 1.f, "%.2f");
        ImGui::Dummy(ImVec2(0, 0));
