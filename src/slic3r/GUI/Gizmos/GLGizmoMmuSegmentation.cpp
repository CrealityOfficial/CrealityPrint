...
void GLGizmoMmuSegmentation::on_render_input_window(float x, float y, float bottom_limit)
{
    ...
    if (m_current_tool == ImGui::CircleButtonIcon || m_current_tool == ImGui::SphereButtonIcon) {
        ...
        bool b_clp_dist_input = cp_drag_float("##clp_dist_input", &clp_dist, 0.05f, 0.f, 1.f, "%.2f");
        ImGui::Dummy(ImVec2(0, 0));
    ...
    if (m_current_tool == ImGui::CircleButtonIcon || m_current_tool == ImGui::SphereButtonIcon || m_current_tool == ImGui::TriangleButtonIcon)
    {
        ImGui::Separator();
