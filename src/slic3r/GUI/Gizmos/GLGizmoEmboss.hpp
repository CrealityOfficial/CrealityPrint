...
private:
	...
	template<typename T>
	bool input_with_arrow_btn(input_value<T>& value, const input_attri& attri);

    bool rev_input(const std::optional<int>* default_value, std::optional<int>& value, int step, int min, int max,const input_attri& attri);
    bool rev_input(const std::optional<float>* default_value, std::optional<float>& value, float step, float min, float max,const input_attri& attri);
    bool rev_input(float* default_value, float& value, float step, float min, float max, const input_attri& attri);
