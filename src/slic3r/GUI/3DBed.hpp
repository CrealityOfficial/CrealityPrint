...
public:
    ...
    enum class Vendor : unsigned char {
        Default = 0,
        Creality
    };
...
private:
    ...
    //Creality
    bool m_is_gcode{ false };
    Vendor m_vendor{ Vendor::Default};
...
public:
    ...
    //Creality: set shape for gcode
    bool set_gcode_shape(const Pointfs& printable_area, const double printable_height, const Preset* preset, const Vec2d position = Vec2d::Zero(), bool with_reset = true);
