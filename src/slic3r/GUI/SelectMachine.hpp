...
public:
    ...
    void render(wxDC &dc);
    void set_force_draw_background(bool force_draw_background);
    void set_background_size(const wxSize &size);
private:
    ScalableBitmap m_background_bitmap;
    wxBitmap bitmap_with_background;
    int m_brightness_value{ -1 };
    bool m_force_draw_background{ false };
    wxSize m_background_size{ 256, 256 };
};
