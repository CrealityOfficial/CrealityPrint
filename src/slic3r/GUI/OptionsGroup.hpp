...
public:
	...
	std::string label_tooltip_img;
    std::string label_hyperlink;
...
public:
    ...
    // BBS: new layout
    wxWindow *     stb;
    wxString  icon;//Can be modified and configured from external files.
    ...
    {
        append_line(create_single_option_line(option, path, subline));
    }
