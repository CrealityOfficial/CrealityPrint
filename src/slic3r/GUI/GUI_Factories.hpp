...
private:
    ...
    wxMenu*     append_submenu_add_creality_model(wxMenu* menu, ModelVolumeType type);
    wxMenu*     append_submenu_add_testing_model(wxMenu* menu, ModelVolumeType type);
    ...
    void        append_menu_item_copy(wxMenu* menu);
    void        append_menu_item_paste(wxMenu* menu);
