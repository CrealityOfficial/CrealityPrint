...
void AuFile::on_input_enter(wxCommandEvent &evt)
{
    ...
    wxString new_fullname_path = wxString(dir.wstring()) + "/" + wxString::FromUTF8(new_fullname.c_str());
    ...
    if (dialog.ShowModal() == wxID_OK) {
        ...
        for (wxString file_path : file_paths) {
            ...
            if (!is_exist) {
                ...
                dir_path += wxString("/") + before_name + "_" + time_text + wxString(src_bfs_path.extension().wstring());
            }
