...
public:
    ...
    std::vector<std::pair<BoundingBoxf3, Transform3d>> get_bounding_every_box_in_current_reference_system();
	...
	std::vector<std::pair<BoundingBoxf3, Transform3d>> get_bounding_evebox_in_reference_system(ECoordinatesType type);
