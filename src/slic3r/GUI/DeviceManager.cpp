...
wxString get_stage_string(int stage)
{
    ...
    case 26:
        return _L("Paused due to CFS lost");
    case 27:
...
void DeviceManager::check_filaments_in_blacklist(std::string tag_vendor, std::string tag_type, bool& in_blacklist, std::string& ac, std::string& info)
{
    ...
    {
        {"TPU: not supported", _L("TPU is not supported by CFS.")},
        {"Bambu PET-CF/PA6-CF: not supported",  _L("PET-CF/PA6-CF is not supported by CFS.")},
        {"PVA: flexible", _L("Damp PVA will become flexible and get stuck inside CFS,please take care to dry it before use.")}, 
        {"CF/GF: hard and brittle", _L("CF/GF filaments are hard and brittle, It's easy to break or get stuck in CFS, please use with caution.")}
    };
