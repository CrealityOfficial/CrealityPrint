...
Button* MsgDialog::add_button(wxWindowID btn_id, bool set_focus /*= false*/, const wxString& label/* = wxString()*/)
{
    ...
    if (btn_id == wxID_OK || btn_id == wxID_YES) {
        btn->SetBackgroundColor(btn_bg_grey);
        btn->SetBorderColor(btn_bd_grey);
...
wxBoxSizer *Newer3mfVersionDialog::get_msg_sizer()
{
    ...
    if (file_version_newer) { 
        text1 = new wxStaticText(this, wxID_ANY, _L("The 3mf file version is in Beta and it is newer than the current CrealityPrint  version."));
        wxStaticText *   text2       = new wxStaticText(this, wxID_ANY, _L("If you would like to try Creality Print Beta, you may click to"));
        ...
        text1 = new wxStaticText(this, wxID_ANY, _L("The 3mf file version is newer than the current Creality Print version."));
        wxStaticText *text2 = new wxStaticText(this, wxID_ANY, _L("Update your Creality Print could enable all functionality in the 3mf file."));
        horizontal_sizer->Add(text2, 0, wxEXPAND, 0);
    }
...
wxBoxSizer *Newer3mfVersionDialog::get_btn_sizer()
{
    ...
    if (!file_version_newer) {
        ...
        m_update_btn->SetBackgroundColor(btn_bg_grey);
    ...
    if (!file_version_newer) {
        ...
        m_later_btn->SetBackgroundColor(btn_bg_grey);
