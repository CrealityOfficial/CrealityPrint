...
void MaterialItem::doRender(wxDC &dc) 
{
    ...
    : PopupWindow(parent, wxBORDER_NONE)
 {
     ...
     auto title_text = new wxStaticText(title_panel, wxID_ANY, _L("CFS Slots"));
     ...
     auto cant_not_match_tip = _L("Note: Only the CFS slots loaded with the same material type can be selected.");
    ...
    :PopupWindow(parent, wxBORDER_NONE)
{
    ...
    m_title_enable_ams = new wxStaticText(m_panel_enable_ams, wxID_ANY, _L("Enable CFS"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_tip_enable_ams = new wxStaticText(m_panel_enable_ams, wxID_ANY, _L("Print with filaments in the CFS"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_title_disable_ams = new wxStaticText(m_panel_disable_ams, wxID_ANY, _L("Disable CFS"), wxDefaultPosition, wxDefaultSize, 0);
...
:PopupWindow(parent, wxBORDER_NONE)
{
    ...
    text_title = new Label(this, Label::Head_14, _L("Config which CFS slot should be used for a filament used in the print job"));
    ...
    tip_bottom = new wxStaticText(this, wxID_ANY, _L("CFS slot used for this filament"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    tip_middle = new wxStaticText(this, wxID_ANY, _L("Click to select CFS slot manually"), wxDefaultPosition, wxDefaultSize, 0);
...
:PopupWindow(parent, wxBORDER_NONE)
{
    ...
    m_staticText_top = new Label(this, _L("Do not Enable CFS"));
...
{
    if (enable_ams) {
        m_staticText_top->SetLabelText(_L("Enable CFS"));
        m_staticText_bottom->SetLabelText(_L("Print with filaments in CFS"));
        m_img_enable_ams->Show();
        m_img_disable_ams->Hide();
    }
    else {
        m_staticText_top->SetLabelText(_L("Do not Enable CFS"));
...
void AmsReplaceMaterialDialog::update_machine_obj(MachineObject* obj)
{
    ...
    if (group_index > 0) {
        ...
        if (!obj->is_support_filament_backup) {
            ...
            label_txt->SetLabelText(_L("CFS filament backup is not enabled, please enable it in the AMS settings."));
        }
        else {
            label_txt->SetLabelText(_L("If there are two identical filaments in CFS, CFSfilament backup will be enabled. \n(Currently supporting automatic supply of consumables with the same brand, material type, and color)"));
        } 
