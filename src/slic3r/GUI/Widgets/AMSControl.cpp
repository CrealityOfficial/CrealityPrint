...
void AMSrefresh::create(wxWindow *parent, wxWindowID id, const wxPoint &pos, const wxSize &size)
{
    ...
    wxPostEvent(this, wxTimerEvent(*m_playing_timer));
    ...
    , m_ams_introduce_popup(AmsIntroducePopup(this))
{
    ...
    m_ams_tip = new Label(m_amswin, _L("CFS"));
    ...
    auto m_tip_none_ams = new wxStaticText(m_none_ams_panel, wxID_ANY, _L("CFS not connected"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTER_HORIZONTAL);
    ...
    auto m_text_calibration_tip = new wxStaticText(m_in_calibration_panel, wxID_ANY, _L("Calibrating CFS..."), wxDefaultPosition, wxDefaultSize, 0);
...
void AMSControl::ShowFilamentTip(bool hasams)
{
    ...
    if (hasams) {
        ...
        m_tip_load_info->SetLabelText(_L("Choose an CFS slot then press \"Load\" or \"Unload\" button to automatically load or unload filaments."));
    } else {
