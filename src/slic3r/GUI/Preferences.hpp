...
#define DESIGN_GRAY300_LIGTH_COLOR wxColour(254, 254, 254)
#define DESIGN_GRAY300_DARK_COLOR wxColour(0, 0, 0)
...
#define DESIGN_COMMON_INPUT_SIZE wxSize(FromDIP(300), -1)
#define LAYOUT_COMMON_INTERVAL 90
...
#endif // WIN32
    wxBoxSizer* create_item_role_radiobutton(wxString title, wxWindow* parent);
    wxBoxSizer* create_default_page_radiobutton(wxString title, wxWindow* parent);
