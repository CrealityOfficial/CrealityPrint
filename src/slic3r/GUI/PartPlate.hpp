...
private:
    ...
    void calc_vertex_for_number(bool one_number, GLModel &buffer);
...
public:
    ...
    std::vector<int> get_model_volume_extruders() const;
...
public:
    ...
    bool is_are_the_slice_results_ready_to_export() const;
    void print() const;
