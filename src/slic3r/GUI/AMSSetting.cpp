...
void AMSSetting::create()
{
    ...
    auto m_static_ams_settings = new wxStaticText(this, wxID_ANY, _L("CFS Settings"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_tip_Insert_material_line1 = new Label(m_panel_Insert_material,
        _L("The CFS will automatically read the filament information when inserting a new Bambu Lab filament. This takes about 20 seconds.")
    );
    ...
    m_tip_Insert_material_line3 = new Label(m_panel_Insert_material,
        _L("When inserting a new filament, the CFS will not automatically read its information, leaving it blank for you to enter manually.")
    );
    ...
    m_tip_starting_line1 = new Label(m_panel_body,
        _L("The CFS will automatically read the information of inserted filament on start-up. It will take about 1 minute.The reading process will roll filament spools.")
    );
    ...
    m_tip_starting_line2 = new Label(m_panel_body,
        _L("The CFS will not automatically read information from inserted filament during startup and will continue to use the information recorded before the last shutdown.")
    );
    ...
    m_tip_remain_line1 = new Label(m_panel_body,
        _L("The CFS will estimate Bambu filament's remaining capacity after the filament info is updated. During printing, remaining capacity will be updated automatically.")
    );
    ...
    m_title_switch_filament = new wxStaticText(m_panel_body, wxID_ANY, _L("CFS filament backup"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_tip_switch_filament_line1 = new Label(m_panel_body,
        _L("CFS will continue to another spool with the same properties of filament automatically when current filament runs out")
    );
