...
wxBitmap create_scaled_bitmap3(const std::string&              bmp_name,
                              wxWindow*                       win             = nullptr,
                              const int                       px_cnt          = 16,
                              const wxSize                    imgSize         = wxSize(),
...
public:
    ...
    void SetBitmapHovered_(const std::string& hover_bmp_name);
    int  GetBitmapHeight();
