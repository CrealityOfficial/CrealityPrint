...
void CalibrationPresetPage::create_selection_panel(wxWindow* parent)
{
    ...
    m_ams_radiobox = new wxRadioButton(m_filament_from_panel, wxID_ANY, _L("CFS"));
    ...
    m_ams_sync_button->SetToolTip(_L("Synchronize filament list from CFS"));
