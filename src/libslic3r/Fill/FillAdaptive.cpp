...
std::pair<double, double> adaptive_fill_line_spacing(const PrintObject &print_object)
{
    ...
    for (size_t region_id = 0; region_id < print_object.num_printing_regions(); ++ region_id) {
        ...
        const size_t             nozzle_index           = get_physical_nozzle_index(print_config, config.sparse_infill_filament - 1);
        ...
        double                   sparse_infill_line_width = nozzle_variant_abs_value(config.sparse_infill_line_width, nozzle_index, nozzle_diameter);
