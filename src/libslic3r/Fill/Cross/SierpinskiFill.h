...
#ifndef ORCA_INFILL_SIERPINSKI_FILL_H
#define ORCA_INFILL_SIERPINSKI_FILL_H
...
namespace Slic3r::Cross
{
    ...
    // static Point no_point(static_cast<signed long long>(std::numeric_limits<signed long long>::min()), static_cast<signed long long>(std::numeric_limits<signed long long>::min()));
    // static Point no_point(static_cast<long long int>(std::numeric_limits<long long>::min()), static_cast<long long int>(std::numeric_limits<long long>::min()));
    //static Point no_point(static_cast<signed long long>(std::numeric_limits<long long>::min()), static_cast<signed long long>(std::numeric_limits<signed long long>::min()));
    ...
    public:
         ...
         * Basic constructor
         */
        SierpinskiFill(const DensityProvider& density_provider, const BoundingBox aabb, int max_depth, const coord_t line_width, bool dithering);
    ...
    protected:
        ...
        BoundingBox aabb; //!< The square which is the basis of the subdivision of the area on which the curve is based.
...
#endif // ORCA_INFILL_SIERPINSKI_FILL_H
