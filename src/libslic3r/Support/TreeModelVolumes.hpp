...
public:
    ...
    void calculateCollision_add(std::vector<std::pair<int, Polygons>>& layer_index, int layer_start_bp_radius);
...
private:
    ...
    std::vector<std::pair<TreeSupportMeshGroupSettings, std::vector<Polygons>>> m_layer_outlines_add;
    /*!
