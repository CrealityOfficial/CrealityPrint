...
protected:
    ...
    Layer(size_t id, PrintObject* object, coordf_t height, coordf_t print_z, coordf_t slice_z, float outer_perimeter_width = 0.0) :
...
protected:
    ...
    struct AreaGroup
    {
        ...
        int        type;
        int        interface_id = 0;
        int        node_type; // 0 , 1, 2     eCircle,eSquare,ePolygon
