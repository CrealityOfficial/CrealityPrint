...
public:
    ...
    std::string toolchange(unsigned int extruder_id, bool change_tool = true);
    ...
    static std::string set_exhaust_fan(int speed, bool add_eol, bool isCrealityOS);
    //BBS
