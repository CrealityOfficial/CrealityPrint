...
#define LONG_RETRACTION_WHEN_CUT                                    "activate_long_retraction_when_cut"
    ...
    private:
        ...
        struct TimeProcessor
        {
            ...
            void post_process(const std::string& filename, std::vector<GCodeProcessorResult::MoveVertex>& moves, std::vector<size_t>& lines_ends, size_t total_layer_num, float flush_times = 0.0f);
        };
