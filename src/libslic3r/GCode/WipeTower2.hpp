...
public:
    ...
    std::vector<std::pair<float, std::vector<float>>> get_used_filament_until_layer() const 
	{ return m_used_filament_length_until_layer; }
...
private:
	...
	struct WipeTowerInfo{
		struct ToolChange {
            ...
            : old_tool{old}, new_tool{newtool}, required_depth{depth}, ramming_depth{ramming_depth}, first_wipe_line{fwl}, wipe_volume_total{wv} {}
		};
