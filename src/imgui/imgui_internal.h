...
namespace ImGui
{
    ...
    IMGUI_API void          CPRenderArrow(ImDrawList* draw_list, ImVec2 pos_min, ImVec2 pos_max, ImU32 col, ImGuiDir dir);
    ...
    IMGUI_API bool          ArrowButtonEX_CP(const char* str_id, ImGuiDir dir, ImVec2 size_arg, ImGuiButtonFlags flags = 0);
