...
namespace ImGui
{
    ...
    // No Hide anything after a '##' string
    IMGUI_API bool          CPBBLBeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags = 0);
    ...
    // No Hide anything after a '##' string
    IMGUI_API bool          CPSelectable(const char* label, bool selected = false, ImGuiSelectableFlags flags = 0, const ImVec2& size = ImVec2(0, 0));
    ...
    IMGUI_API ImVec2        GetItemDispMin();                                                  // get size of last item
