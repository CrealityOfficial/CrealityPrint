...
public:
	...
	Q_INVOKABLE void deleteSelectedVideoFile(const QString& ipAddress);
	Q_INVOKABLE void downloadSelectedVideoFile(const QString& macAddr,const QString& ipAddress,const QString& localPath);
	Q_INVOKABLE void setVideoFileSelected(bool select);
	...
	Q_PROPERTY(int videoFileSelectedCount READ videoFileSelectedCount NOTIFY videoFileSelectedCountChanged);


	int videoFileSelectedCount();
...
signals:
	void videoFileSelectedCountChanged();
...
public:
	...
	Q_PROPERTY(bool videoSelected	    READ videoSelected		  WRITE setVideoSelected		NOTIFY videoSelectedChanged)
