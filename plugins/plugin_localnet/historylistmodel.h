...
public:
	...
	Q_INVOKABLE void deleteSelectedHistoryFile(const QString& ipAddress);
	Q_INVOKABLE void downloadSelectedHistoryFile(const QString& macAddr,const QString& ipAddress,const QString& localPath);
	Q_INVOKABLE void setHistoryFileSelected(bool select);
	...
	Q_PROPERTY(int historyFileSelectedCount READ historyFileSelectedCount NOTIFY historyFileSelectedCountChanged);
	Q_PROPERTY(QStringList historyFileSelectedList READ historyFileSelectedList NOTIFY historyFileSelectedCountChanged);

	int historyFileSelectedCount();

	QStringList historyFileSelectedList();
...
signals:
	void historyFileSelectedCountChanged();
...
public:
	...
	Q_PROPERTY(bool historySelected	    READ historySelected		  WRITE setHistorySelected		NOTIFY historySelectedChanged)
	Q_PROPERTY(QString historyIsMultiColor	    READ historyIsMultiColor		  WRITE setHistoryIsMultiColor		NOTIFY historyIsMultiColorChanged)
	...
	bool historySelected() const;
	void setHistorySelected(bool selected);

	QString historyIsMultiColor() const;
	void setHistoryIsMultiColor(const QString& isMulti);
...
signals:
	...
	void historySelectedChanged();
	void historyIsMultiColorChanged();
...
private:
	...
	bool 	m_historySelected;
	QString m_historyIsMultiColor;
