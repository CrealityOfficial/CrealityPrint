...
public:
    ...
    explicit Cx3dWriter(QString path,qtuser_core::Progressor* progressor,QObject *parent = nullptr, bool isBackup = false);
    ~Cx3dWriter();
    ...
    void saveFDMSupport(QString strName, QString strPathName, creative_kernel::ModelN* model);
