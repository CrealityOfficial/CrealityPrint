...
DockItem {
    ...
    ListModel{
        id: _aModel
        ListElement{key:qsTr("Starting speed");text: "10";value: "10";unit:"mm/s";min:0;}
        ListElement{key:qsTr("End speed");text: "80";value: "80";unit:"mm/s";min:1;}
        ListElement{key:qsTr("Step");text: "5";value: "5";unit:"mm/s";min:1;}
                ...
                Repeater{
                    ...
                    delegate: RowLayout{
                        ...
                        BasicDialogTextField{
                            ...
                            text:model.text
                            unitChar:model.unit
                            validator:IntValidator {bottom: model.min} // model.index==2 ? DoubleValidator{bottom: model.min; decimals:2}: IntValidator {bottom: model.min}
                            onTextChanged:{
