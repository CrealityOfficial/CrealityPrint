...
DockItem {
    ...
    ListModel{
        id: _aModel
        ListElement{key:qsTr("Starting speed");text: "0";value: "0";unit:"%";min:0;max:100}
        ListElement{key:qsTr("End speed");text: "100";value: "100";unit:"%";min:1;max:100}
        ListElement{key:qsTr("Step");text: "10";value: "10";unit:"%";}
