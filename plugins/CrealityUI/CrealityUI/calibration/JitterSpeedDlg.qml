...
DockItem {
    ...
    ListModel{
        id: _aModel
        ListElement{key:qsTr("Starting speed");text: "5";value: "5";unit:"mm/s";min:0;max:15}
        ListElement{key:qsTr("End speed");text: "15";value: "15";unit:"mm/s";min:1;max:15}
        ListElement{key:qsTr("Step");text: "1";value: "5";unit:"mm/s";min:1;max:5}
    ...
    Column
    {
        ...
        BasicDialogButton {
            ...
            onSigButtonClicked:
           {
                ...
                if(startTemp>endTemp||endTemp<=(startTemp+step)){
