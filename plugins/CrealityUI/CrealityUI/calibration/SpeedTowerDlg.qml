...
DockItem {
    ...
    ListModel{
        id: _aModel
        ListElement{key:qsTr("Starting speed");text: "40";value: "40";unit:"mm/s";min:0;max:5000}
        ListElement{key:qsTr("End speed");text: "300";value: "300";unit:"mm/s2";min:1;max:5000}
        ListElement{key:qsTr("Step");text: "10";value: "10";unit:"mm/s2";min:1;max:10}
