...
DockItem {
    ...
    height: (Constants.languageType == 0 ? 300 : 350) *  screenScaleFactor //mac中文字显示差异，需多留空白
    titleHeight : 30 * screenScaleFactor
    property int spacing: 5
    title: qsTr("Max speed")
    ...
    ListModel{
        id: _aModel
        ListElement{key:qsTr("Starting speed");text: "50";value: "50";min:0;max:600;unit:"mm/s"}
        ListElement{key:qsTr("End speed");text: "400";value: "400";min:1;max:600;unit:"mm/s"}
        ListElement{key:qsTr("Step");text: "10";value:"10";min:1;max:10;unit:"mm/s"}
        ListElement{key:qsTr("Acceleration");text: "5000";value:"5000";min:0;max:999999;unit:"mm/s2"}
