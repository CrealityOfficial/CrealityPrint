...
Window
{
    ...
    onVisibleChanged: function() {
        if (cxkernel_cxcloud.realServerType === 0) {
            if (visible) {
            ...
            Column {
                ...
                Row {
                    ...
                    Control {
                        ...
                        readonly property int currentIndex: cxkernel_cxcloud.serverType
                        readonly property string currentText: cxkernel_cxcloud.serverListModel.get(currentIndex).model_name
                        ...
                        contentItem: Text {
                            ...
                            font: Constants.font
                            text: qsTr(parent.currentText)
                        }

                        BasicTooltip {
                            visible: parent.hovered
                            position: BasicTooltip.Position.BOTTOM
                            text: cxTr('login_dialog_change_area_tip')
                        }
                    }
                }
                ...
                Row {
                    ...
                    RadioButton {
                        ...
                        visible: cxkernel_cxcloud.realServerType === 0
