...
DockItem {
    ...
    Grid{
        ...
        StyledLabel{
            ...
            width: 230* screenScaleFactor
            height: 30* screenScaleFactor
            text: qsTr("Push parameters update")
            font.pointSize:Constants.labelFontPointSize_10
            color: Constants.themeTextColor
            verticalAlignment: Qt.AlignVCenter
            horizontalAlignment: Qt.AlignLeft
        ...
        StyledLabel{
            ...
            width: 230* screenScaleFactor
            height: 30* screenScaleFactor
            text: qsTranslate("ParameterComponent", "Advanced settings options enabled by default")
            font.pointSize:Constants.labelFontPointSize_10
            color: Constants.themeTextColor
            verticalAlignment: Qt.AlignVCenter
            horizontalAlignment: Qt.AlignLeft
        ...
        CheckBox {
            ...
            Component.onCompleted: {
                checked = kernel_ui_parameter.advanceSettingDefault
            }

            onCheckedChanged: {
                if (kernel_ui_parameter.advanceSettingDefault != checked) {
                    kernel_ui_parameter.advanceSettingDefault = checked
                    if (kernel_ui_parameter.advanceSettingDefault) {
                        kernel_ui_parameter.advanceSettingEnabled = true
                    }
                }
            }
            ...
            Connections {
                ...
                function onAdvanceSettingDefaultChanged() {
                    if (advance_default_button.checked != kernel_ui_parameter.advanceSettingDefault) {
                        advance_default_button.checked = kernel_ui_parameter.advanceSettingDefault
                    }
                }
            }
            ...
            background: Rectangle {
                ...
                border.color: advance_default_button.checked || advance_default_button.hovered
                              ? Constants.right_panel_border_hovered_color
                              : Constants.right_panel_border_default_color
                color: advance_default_button.checked
                       ? Constants.themeGreenColor : "transparent"
            }
            ...
            indicator: Image {
                ...
                height: 6 * screenScaleFactor
                anchors.centerIn: parent
                visible: advance_default_button.checked
