...
//    panelColor: sourceTheme.background_color
    ...
    onVisibleChanged: {
        ...
        if(visible){
            ...
            // cloader.item.material_type.model = null
            // cloader.item.material_type.model = Qt.binding(function(){ return  kernel_material_center.types() })
            // cloader.item.material_name.model = null
            // cloader.item.material_name.model = Qt.binding(function(){ return  kernel_parameter_manager.currentMachineObject.materialsModelProxy(); })
            material_type.model= null
            material_name.model = null
        ...
        Column{
            ...
            ScrollView{
                ...
                Grid{
                    ...
                    Repeater {
                        id: material_name
                        // model: kernel_parameter_manager.currentMachineObject.materialsModelProxy()//kernel_parameter_manager.machineObject(second_step.curIndex).materialsModelProxy()  //kernel_parameter_manager.currentMachineObject.materialsModelProxy()
                        delegate: CusCheckBox {
                            text: meName
                            textColor: Constants.themeTextColor
                            font.pointSize: Constants.labelFontPointSize_9
