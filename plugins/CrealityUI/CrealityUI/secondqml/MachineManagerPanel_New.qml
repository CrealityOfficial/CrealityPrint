            ...
            RowLayout {
                ...
                SearchComboBox {
                    ...
                    popup.onOpened: _ => {
                        ...
                        proxy_model.minimumLevel = Qt.binding(_ => idAdvance.currentLevel)
                ...
                Row {
                    ...
                    CusSwitchBtn {
                        ...
                        btnColor: checked ? "#ffffff" : "#6E6E73"
                        anchors.verticalCenter: parent.verticalCenter
                        btnHeight: 20 * screenScaleFactor
                        checked: kernel_parameter_manager.getMachineAdvanced()
                        onClicked: kernel_parameter_manager.setMachineAdvanced(idAdvance.checked)
                    }
                        ...
                        onClicked: {
                            ...
                            if (machine_view.curItemIsModified) {
                                ...
                                receiver.onIgnore = function() {
                                    ...
                                    kernel_parameter_manager.setCurrentMachine(model.index);
                    ...
                    Repeater {
                        ...
                        delegate: CustomTabViewItem {
                            ...
                            Loader {
                                ...
                                readonly property int currentLevel: idAdvance.currentLevel
