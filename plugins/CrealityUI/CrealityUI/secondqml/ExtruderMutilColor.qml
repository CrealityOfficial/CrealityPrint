...
Flow {
    ...
    Repeater {
        ...
        delegate: Button {
            ...
            width: colorRecRepeater.count <= 8 ? height * 2 + root.spacing : height
                ...
                Rectangle {
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            ...
                            kernel_model_list_data.setColor(-1, color, model.index);
                ...
                Rectangle {
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            ...
                            chosedMaterial.materialIndex = model.extruderMaterialIndex;
                        ...
                        onEntered: {
                            ...
                            console.log("materialTypeText.contentWidth = ", materialTypeText.contentWidth, "width = ", materialTypeText.width)
    ...
    Popup {
        ...
        contentItem: RowLayout {
            ...
            CXComboBox {
                //                currentIndex: extruderObj.materialIndex
            ...
            Item {
                ...
                Row {
                    ...
                    CusText {
                        id: extruderTempText
                        fontText: {
                            let materialObj = currentMachine.materialObject(Number(chosedMaterial.materialIndex));
            ...
            CusButton {
                ...
                onClicked: {
                    ...
                    console.log("index =============== ", idExtruder11.currentIndex)
