...
ColumnLayout {
    ...
    UploadMessageDlg {
        ...
        msgText: qsTr("No AMS material found. Please select the printer on the 'Device' page and the AMS information will be loaded.")
    ...
    PanelTitle {
        ...
        CusImglButton {
            ...
            highLightIconSource: enabledIconSource
            pressedIconSource: enabledIconSource
            cusTooltip.text: qsTr("Sync material")
            cusTooltip.position: BasicTooltip.Position.BOTTOM
        ...
        CusImglButton {
            ...
            highLightIconSource: enabledIconSource
            pressedIconSource: enabledIconSource
            cusTooltip.text: qsTr("Edit Materials")
            cusTooltip.position: BasicTooltip.Position.BOTTOM
    ...
    Rectangle {
        ...
        CusRoundedBg {
            ...
            RowLayout {
                ...
                CusRoundedBg {
                    ...
                    property real maxWidth: 200 * screenScaleFactor
                    property real minWidth: 70 * screenScaleFactor
                    ...
                    borderColor: Constants.right_panel_border_default_color
                    onWidthChanged: {
                        model_list_view.leftWidth = width;
                    }
        ...
        ModelListView {
            ...
            readonly property real fullHeight: contentHeight + anchors.topMargin + anchors.bottomMargin
            property real leftWidth: 160 * screenScaleFactor

            leftRecWidth: model_list_view.leftWidth
            width: parent.width
            height: objectRec.height - headerItem.height
    ...
    PanelTitle {
        ...
        Button {
            ...
            readonly property int currentLevel: checked ? 0 : 2
        ...
        CustomComboBox {
            id: process_level_combo_box

            readonly property var currentModel: model.get(currentIndex)
            readonly property int currentLevel: currentModel.level
            readonly property int customIndex: model.customIndex
            readonly property bool customized: currentIndex === customIndex
            readonly property bool actived: popup.visible

            visible: false
            Layout.preferredWidth: 24 * screenScaleFactor
            Layout.preferredHeight: 24 * screenScaleFactor

            model: kernel_ui_parameter.processLevelListModel
            textRole: "name"
            translater: source => qsTr(source)
            currentIndex: model.defaultIndex

            popup.width: 100 * screenScaleFactor + popup.padding * 2
            popup.height: popup.implicitContentHeight + popup.padding * 2

            Component.onCompleted: {
                this.currentIndex = model.currentIndex
                model.currentIndex = Qt.binding(_ => this.currentIndex)
            }

            BasicTooltip {
                visible: process_level_combo_box.hovered
                textWrap: false
                text: "%1 : %2".arg(qsTr("Level")).arg(process_level_combo_box.displayText)
            }

            background: Rectangle {
                radius: 5 * screenScaleFactor
                color: parent.actived ? Constants.right_panel_border_checked_color
                                      : parent.hovered ? Constants.right_panel_button_hovered_color
                                                       : Constants.right_panel_button_default_color
                border.width: parent.hovered ? 1 * screenScaleFactor : 0
                border.color: Constants.right_panel_border_hovered_color
            }
            ...
            contentItem: Item {
                Image {
                    ...
                    horizontalAlignment: Qt.AlignHCenter
                    verticalAlignment: Qt.AlignVCenter
                    source: Constants.right_panel_process_level_image
                    fillMode: Image.PreserveAspectFit
                    width: 14 * screenScaleFactor
    ...
    StackLayout {
        ...
        RowLayout {
            ...
            CustomComboBox {
                ...
                property bool currnetModelModifyed: model.get(currentIndex).object.dataModel.settingsModifyed
                    ...
                    contentItem: RowLayout {
                        ...
                        Button {
                            ...
                            onClicked: {
                                ...
                                //                                process_combo_box.currentProfileObj = model.object
                    ...
                    sourceComponent: FlattenTreeView {
                        ...
                        leafNodeDelegate: Loader {
                            ...
                            readonly property bool vaild: {
                                ...
                                return global_object_switch.leftChecked ? dataModel.processSettable
                                                                        : dataModel.meshSettable
                            }
            ...
            GridLayout {
                ...
                function initialize() {
                    ...
                    plate_type_combo_box.currentIndex = (_ => {
                                                             switch (printer.parameter("curr_bed_type")) {
                                                                 // case "Cool Plate": return 1
                                                                 // case "Engineering Plate": return 2
                                                                 // case "High Temp Plate": return 3
                                                                 // case "Textured PEI Plate": return 4

                                                                 case "High Temp Plate": return 1
                                                                 case "Textured PEI Plate": return 2
                                                                 case "Cool Plate": return 3
                ...
                CustomComboBox {
                    ...
                    onCurrentIndexChanged: {
                        ...
                        plate_config_layout.printer.setParameter("curr_bed_type", (_ => {
                                                                                       switch (currentIndex) {
                                                                                           // case 1: return "Cool Plate"
                                                                                           // case 2: return "Engineering Plate"
                                                                                           // case 3: return "High Temp Plate"
                                                                                           // case 4: return "Textured PEI Plate"

                                                                                           case 1: return "High Temp Plate"
                                                                                           case 2: return "Textured PEI Plate"
                                                                                           case 3: return "Cool Plate"
                ...
                CustomComboBox {
                    ...
                    onCurrentIndexChanged: {
                        ...
                        if (filament_sequence_combo_box.currentIndex === 0) {
