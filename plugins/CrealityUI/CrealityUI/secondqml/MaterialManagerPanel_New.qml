...
BasicDialogV4 {
    ...
    property var focusedMaterial: currentMachine ? currentMachine.materialObject(cloader.item.materialView.currentIndex) : null
    ...
    Connections{
        ...
        onFocusedMaterialNameChanged:{
            ...
            focusedMaterial = Qt.binding(function(){ return currentMachine ? currentMachine.materialObject(cloader.item.materialView.currentIndex) : null; })
        }
    }

    ParameterComponent {
        id: parameter_components
            ...
            RowLayout {
                ...
                Switch {
                    ...
                    contentItem: Label {
                        ...
                        anchors.right: parent.background.left
                            ...
                            Component {
                                ...
                                FlattenTreeView {
                                    ...
                                    leafNodeDelegate: Loader {
                                        ...
                                        active: dataModel
                                        sourceComponent: parameter_components.parameter
                                                        ...
                                                        Loader {
                                                            ...
                                                            sourceComponent: ColumnLayout {
                                                                ...
                                                                RowLayout {
                                                                    ...
                                                                    Label {
                                                                        Layout.fillWidth: true
                                                                        Layout.minimumHeight: parameter_components.minimumHeight
                                                                        Layout.maximumHeight: Layout.minimumHeight
                                                                        horizontalAlignment: Qt.AlignLeft
                                                                        verticalAlignment: Qt.AlignVCenter
                                                                        font: Constants.font
                                                            ...
                                                            Repeater {
                                                                ...
                                                                delegate: RowLayout {
                                                                    ...
                                                                    Loader {
                                                                        ...
                                                                        sourceComponent: parameter_components.profileItemRow
                                                                    }
                ...
                BasicButton {
                    ...
                    onSigButtonClicked: function() {
                        ...
                        receiver.exec = function() {
                            ...
                            material_view.currentIndex = 0
                            focusedMaterial = Qt.binding(function(){ return currentMachine.materialObject(material_view.currentIndex) })
                        };
