                    ...
                    ComboBox {
                        ...
                        onCurrentIndexChanged: {
                            if (currentIndex != -1) {
                                ...
                                curLoginType !== LoginDlg.LoginType.Qrcode_Type ? resetBtnSelect()
                                    : cxkernel_cxcloud.accountService.refreshQrcode()
                            }
                        }
                    ...
                    Item {
                        ...
                        Text {
                            ...
                            MouseArea {
                                ...
                                anchors.fill: parent
                                cursorShape: containsMouse ? Qt.PointingHandCursor : Qt.ArrowCursor
                                onClicked: Qt.openUrlExternally(resetPassWordWebsitebyPhone)
                            }
                        }
                        ...
                        Row {
                            ...
                            Text {
                                ...
                                MouseArea {
                                    ...
                                    anchors.fill: parent
                                    cursorShape: containsMouse ? Qt.PointingHandCursor : Qt.ArrowCursor
                                    onClicked: Qt.openUrlExternally(signupWebsitebyPhone)
                                }
                            }
                        }
                    }
                    ...
                    Item {
                        ...
                        Text {
                            ...
                            MouseArea {
                                ...
                                anchors.fill: parent
                                cursorShape: containsMouse ? Qt.PointingHandCursor : Qt.ArrowCursor
                                onClicked: Qt.openUrlExternally(resetPassWordWebsitebyMail)
                            }
                        }
                        ...
                        Row {
                            ...
                            Text {
                                ...
                                MouseArea {
                                    ...
                                    anchors.fill: parent
                                    cursorShape: containsMouse ? Qt.PointingHandCursor : Qt.ArrowCursor
                                    onClicked: Qt.openUrlExternally(signupWebsitebyMail)
                                }
                            }
                        }
                    }
                            ...
                            Rectangle {
                                ...
                                Text {
                                    ...
                                    text: qsTr("Me section in app > Scan icon on top") + "<br>" +
                                          qsTr("You are browsing") + " " + "<font color='#1CA4F1'>" + qsTr("crealitycloud.cn") + ", " + "</font>" +
                                          qsTr("Please use the") + " " + "<font color='#1CA4F1'>" + qsTr("Creality Cloud App (CN version)") + "</font>" + " " +
                                ...
                                Text {
                                    ...
                                    color: Constants.themeTextColor
                                    text: qsTr("Me section in app > Scan icon on top") + "<br>" +
                                          qsTr("You are browsing") + " " + "<font color='#1CA4F1'>" + qsTr("crealitycloud.com") + ", " + "</font>" +
                                          qsTr("Please use the") + " " + "<font color='#1CA4F1'>" + qsTr("Creality Cloud App") + "</font>" + " " +
                                          qsTr("to scan the QR code")
                                }
