...
BasicDialogV4 {
    ...
    property string resetPassWordWebsitebyMail: basicWebUrl + "?resetpassword=0&channel=creality-print"
    property string resetPassWordWebsitebyPhone: basicWebUrl + "?resetpassword=1&channel=creality-print"
    property string qrsource: "image://login_qrcode_image_provider"
    property string txtErrorMsg: ""

    function showErrorMsg(errormsg) {
        txtErrorMsg = qsTr(errormsg);
        console.log("error:" + txtErrorMsg);
    }
    ...
    Connections {
        ...
        onQrcodeRefreshed: {
            qrsource = "";
            qrsource = "image://login_qrcode_image_provider";
    ...
    ListModel {
        ...
        ListElement {
            key: "93"
            modelData: qsTr("Afghanistan")
        }

        ListElement {
            key: "335"
            modelData: qsTr("Albania")
        }

        ListElement {
            key: "213"
            modelData: qsTr("Algeria")
        }

        ListElement {
            key: "376"
            modelData: qsTr("Andorra")
        }

        ListElement {
            key: "0244"
            modelData: qsTr("Angola")
        }

        ListElement {
            key: "1254"
            modelData: qsTr("Anguilla")
        }

        ListElement {
            key: "1268"
            modelData: qsTr("Antigua and Barbuda")
        }

        ListElement {
            key: "54"
            modelData: qsTr("Argentina")
        }

        ListElement {
            key: "374"
            modelData: qsTr("Armenia")
        }

        ListElement {
            key: "247"
            modelData: qsTr("Ascension")
        }

        ListElement {
            key: "61"
            modelData: qsTr("Australia")
        }

        ListElement {
            key: "43"
            modelData: qsTr("Austria")
        }

        ListElement {
            key: "994"
            modelData: qsTr("Azerbaijan")
        }

        ListElement {
            key: "1242"
            modelData: qsTr("Bahamas")
        }

        ListElement {
            key: "973"
            modelData: qsTr("Bahrain")
        }

        ListElement {
            key: "880"
            modelData: qsTr("Bangladesh")
        }

        ListElement {
            key: "1246"
            modelData: qsTr("Barbados")
        }

        ListElement {
            key: "375"
            modelData: qsTr("Belarus")
        }

        ListElement {
            key: "32"
            modelData: qsTr("Belgium")
        }

        ListElement {
            key: "501"
            modelData: qsTr("Belize")
        }

        ListElement {
            key: "229"
            modelData: qsTr("Benin")
        }

        ListElement {
            key: "1441"
            modelData: qsTr("Bermuda Is")
        }

        ListElement {
            key: "591"
            modelData: qsTr("Bolivia")
        }

        ListElement {
            key: "267"
            modelData: qsTr("Botswana")
        }

        ListElement {
            key: "55"
            modelData: qsTr("Brazil")
        }

        ListElement {
            key: "673"
            modelData: qsTr("Brunei")
        }

        ListElement {
            key: "359"
            modelData: qsTr("Bulgaria")
        }

        ListElement {
            key: "226"
            modelData: qsTr("Burkina Faso")
        }

        ListElement {
            key: "95"
            modelData: qsTr("Burma")
        }

        ListElement {
            key: "257"
            modelData: qsTr("Burundi")
        }

        ListElement {
            key: "237"
            modelData: qsTr("Cameroon")
        }

        ListElement {
            key: "1"
            modelData: qsTr("Canada")
        }

        ListElement {
            key: "1345"
            modelData: qsTr("Cayman Is")
        }

        ListElement {
            key: "236"
            modelData: qsTr("Central African Republic")
        }
        ...
        ListElement {
            key: "56"
            modelData: qsTr("Chile")
        }

        ListElement {
            key: "86"
            modelData: qsTr("China")
        }

        ListElement {
            key: "57"
            modelData: qsTr("Colombia")
        }

        ListElement {
            key: "242"
            modelData: qsTr("Congo")
        }

        ListElement {
            key: "682"
            modelData: qsTr("Cook Is")
        }

        ListElement {
            key: "506"
            modelData: qsTr("Costa Rica")
        }
        ...
        ListElement {
            key: "357"
            modelData: qsTr("Cyprus")
        }

        ListElement {
            key: "420"
            modelData: qsTr("Czech Republic")
        }

        ListElement {
            key: "45"
            modelData: qsTr("Denmark")
        }

        ListElement {
            key: "253"
            modelData: qsTr("Djibouti")
        }

        ListElement {
            key: "1890"
            modelData: qsTr("Dominica Rep")
        }

        ListElement {
            key: "503"
            modelData: qsTr("EI Salvador")
        }

        ListElement {
            key: "593"
            modelData: qsTr("Ecuador")
        }

        ListElement {
            key: "20"
            modelData: qsTr("Egypt")
        }

        ListElement {
            key: "372"
            modelData: qsTr("Estonia")
        }

        ListElement {
            key: "251"
            modelData: qsTr("Ethiopia")
        }
        ...
        ListElement {
            key: "358"
            modelData: qsTr("Finland")
        }

        ListElement {
            key: "33"
            modelData: qsTr("France")
        }

        ListElement {
            key: "594"
            modelData: qsTr("French Guiana")
        }

        ListElement {
            key: "689"
            modelData: qsTr("French Polynesia")
        }

        ListElement {
            key: "241"
            modelData: qsTr("Gabon")
        }

        ListElement {
            key: "220"
            modelData: qsTr("Gambia")
        }

        ListElement {
            key: "995"
            modelData: qsTr("Georgia")
        }

        ListElement {
            key: "49"
            modelData: qsTr("Germany")
        }

        ListElement {
            key: "233"
            modelData: qsTr("Ghana")
        }

        ListElement {
            key: "350"
            modelData: qsTr("Gibraltar")
        }

        ListElement {
            key: "30"
            modelData: qsTr("Greece")
        }

        ListElement {
            key: "1809"
            modelData: qsTr("Grenada")
        }
        ...
        ListElement {
            key: "502"
            modelData: qsTr("Guatemala")
        }

        ListElement {
            key: "224"
            modelData: qsTr("Guinea")
        }

        ListElement {
            key: "592"
            modelData: qsTr("Guyana")
        }

        ListElement {
            key: "509"
            modelData: qsTr("Haiti")
        }

        ListElement {
            key: "504"
            modelData: qsTr("Honduras")
        }

        ListElement {
            key: "852"
            modelData: qsTr("Hong Kong")
        }

        ListElement {
            key: "36"
            modelData: qsTr("Hungary")
        }

        ListElement {
            key: "354"
            modelData: qsTr("Iceland")
        }

        ListElement {
            key: "91"
            modelData: qsTr("India")
        }

        ListElement {
            key: "62"
            modelData: qsTr("Indonesia")
        }
        ...
        ListElement {
            key: "353"
            modelData: qsTr("Ireland")
        }

        ListElement {
            key: "972"
            modelData: qsTr("Israel")
        }

        ListElement {
            key: "39"
            modelData: qsTr("Italy")
        }

        ListElement {
            key: "225"
            modelData: qsTr("Ivory Coast")
        }

        ListElement {
            key: "1876"
            modelData: qsTr("Jamaica")
        }

        ListElement {
            key: "81"
            modelData: qsTr("Japan")
        }

        ListElement {
            key: "962"
            modelData: qsTr("Jordan")
        }

        ListElement {
            key: "855"
            modelData: qsTr("Kampuchea (Cambodia )")
        }

        ListElement {
            key: "327"
            modelData: qsTr("Kazakstan")
        }

        ListElement {
            key: "254"
            modelData: qsTr("Kenya")
        }

        ListElement {
            key: "82"
            modelData: qsTr("Korea")
        }

        ListElement {
            key: "965"
            modelData: qsTr("Kuwait")
        }

        ListElement {
            key: "331"
            modelData: qsTr("Kyrgyzstan")
        }
        ...
        ListElement {
            key: "371"
            modelData: qsTr("Latvia")
        }

        ListElement {
            key: "961"
            modelData: qsTr("Lebanon")
        }

        ListElement {
            key: "266"
            modelData: qsTr("Lesotho")
        }

        ListElement {
            key: "231"
            modelData: qsTr("Liberia")
        }

        ListElement {
            key: "218"
            modelData: qsTr("Libya")
        }

        ListElement {
            key: "4175"
            modelData: qsTr("Liechtenstein")
        }

        ListElement {
            key: "370"
            modelData: qsTr("Lithuania")
        }

        ListElement {
            key: "352"
            modelData: qsTr("Luxembourg")
        }

        ListElement {
            key: "853"
            modelData: qsTr("Macao")
        }

        ListElement {
            key: "261"
            modelData: qsTr("Madagascar")
        }

        ListElement {
            key: "265"
            modelData: qsTr("Malawi")
        }

        ListElement {
            key: "60"
            modelData: qsTr("Malaysia")
        }

        ListElement {
            key: "960"
            modelData: qsTr("Maldives")
        }
        ...
        ListElement {
            key: "356"
            modelData: qsTr("Malta")
        }

        ListElement {
            key: "1670"
            modelData: qsTr("Mariana Is")
        }

        ListElement {
            key: "596"
            modelData: qsTr("Martinique")
        }

        ListElement {
            key: "230"
            modelData: qsTr("Mauritius")
        }

        ListElement {
            key: "52"
            modelData: qsTr("Mexico")
        }

        ListElement {
            key: "373"
            modelData: qsTr("Moldova")
        }

        ListElement {
            key: "377"
            modelData: qsTr("Monaco")
        }

        ListElement {
            key: "976"
            modelData: qsTr("Mongolia")
        }

        ListElement {
            key: "1664"
            modelData: qsTr("Montserrat Is")
        }

        ListElement {
            key: "212"
            modelData: qsTr("Morocco")
        }

        ListElement {
            key: "258"
            modelData: qsTr("Mozambique")
        }

        ListElement {
            key: "264"
            modelData: qsTr("Namibia")
        }

        ListElement {
            key: "674"
            modelData: qsTr("Nauru")
        }

        ListElement {
            key: "977"
            modelData: qsTr("Nepal")
        }

        ListElement {
            key: "599"
            modelData: qsTr("Netheriands Antilles")
        }

        ListElement {
            key: "31"
            modelData: qsTr("Netherlands")
        }

        ListElement {
            key: "64"
            modelData: qsTr("New Zealand")
        }

        ListElement {
            key: "505"
            modelData: qsTr("Nicaragua")
        }

        ListElement {
            key: "227"
            modelData: qsTr("Niger")
        }

        ListElement {
            key: "234"
            modelData: qsTr("Nigeria")
        }

        ListElement {
            key: "850"
            modelData: qsTr("North Korea")
        }

        ListElement {
            key: "47"
            modelData: qsTr("Norway")
        }
        ...
        ListElement {
            key: "92"
            modelData: qsTr("Pakistan")
        }

        ListElement {
            key: "507"
            modelData: qsTr("Panama")
        }

        ListElement {
            key: "675"
            modelData: qsTr("Papua New Cuinea")
        }

        ListElement {
            key: "595"
            modelData: qsTr("Paraguay")
        }
        ...
        ListElement {
            key: "63"
            modelData: qsTr("Philippines")
        }

        ListElement {
            key: "48"
            modelData: qsTr("Poland")
        }

        ListElement {
            key: "351"
            modelData: qsTr("Portugal")
        }

        ListElement {
            key: "1787"
            modelData: qsTr("Puerto Rico")
        }

        ListElement {
            key: "974"
            modelData: qsTr("Qatar")
        }

        ListElement {
            key: "262"
            modelData: qsTr("Reunion")
        }

        ListElement {
            key: "40"
            modelData: qsTr("Romania")
        }

        ListElement {
            key: "7"
            modelData: qsTr("Russia")
        }

        ListElement {
            key: "1758"
            modelData: qsTr("Saint Lueia")
        }

        ListElement {
            key: "1784"
            modelData: qsTr("Saint Vincent")
        }

        ListElement {
            key: "684"
            modelData: qsTr("Samoa Eastern")
        }

        ListElement {
            key: "685"
            modelData: qsTr("Samoa Western")
        }

        ListElement {
            key: "378"
            modelData: qsTr("San Marino")
        }

        ListElement {
            key: "239"
            modelData: qsTr("Sao Tome and Principe")
        }

        ListElement {
            key: "966"
            modelData: qsTr("Saudi Arabia")
        }

        ListElement {
            key: "221"
            modelData: qsTr("Senegal")
        }

        ListElement {
            key: "248"
            modelData: qsTr("Seychelles")
        }

        ListElement {
            key: "232"
            modelData: qsTr("Sierra Leone")
        }

        ListElement {
            key: "65"
            modelData: qsTr("Singapore")
        }

        ListElement {
            key: "421"
            modelData: qsTr("Slovakia")
        }

        ListElement {
            key: "386"
            modelData: qsTr("Slovenia")
        }

        ListElement {
            key: "677"
            modelData: qsTr("Solomon Is")
        }

        ListElement {
            key: "252"
            modelData: qsTr("Somali")
        }

        ListElement {
            key: "27"
            modelData: qsTr("South Africa")
        }

        ListElement {
            key: "34"
            modelData: qsTr("Spain")
        }

        ListElement {
            key: "94"
            modelData: qsTr("SriLanka")
        }

        ListElement {
            key: "1758"
            modelData: qsTr("St.Lucia")
        }

        ListElement {
            key: "1784"
            modelData: qsTr("St.Vincent")
        }

        ListElement {
            key: "249"
            modelData: qsTr("Sudan")
        }

        ListElement {
            key: "597"
            modelData: qsTr("Suriname")
        }

        ListElement {
            key: "268"
            modelData: qsTr("Swaziland")
        }

        ListElement {
            key: "46"
            modelData: qsTr("Sweden")
        }

        ListElement {
            key: "41"
            modelData: qsTr("Switzerland")
        }

        ListElement {
            key: "963"
            modelData: qsTr("Syria")
        }

        ListElement {
            key: "886"
            modelData: qsTr("Taiwan")
        }

        ListElement {
            key: "992"
            modelData: qsTr("Tajikstan")
        }

        ListElement {
            key: "255"
            modelData: qsTr("Tanzania")
        }

        ListElement {
            key: "66"
            modelData: qsTr("Thailand")
        }
        ...
        ListElement {
            key: "676"
            modelData: qsTr("Tonga")
        }

        ListElement {
            key: "1809"
            modelData: qsTr("Trinidad and Tobago")
        }

        ListElement {
            key: "216"
            modelData: qsTr("Tunisia")
        }

        ListElement {
            key: "90"
            modelData: qsTr("Turkey")
        }

        ListElement {
            key: "993"
            modelData: qsTr("Turkmenistan")
        }

        ListElement {
            key: "256"
            modelData: qsTr("Uganda")
        }

        ListElement {
            key: "380"
            modelData: qsTr("Ukraine")
        }

        ListElement {
            key: "971"
            modelData: qsTr("United Arab Emirates")
        }

        ListElement {
            key: "44"
            modelData: qsTr("United Kingdom")
        }

        ListElement {
            key: "1"
            modelData: qsTr("United States of America")
        }

        ListElement {
            key: "598"
            modelData: qsTr("Uruguay")
        }

        ListElement {
            key: "233"
            modelData: qsTr("Uzbekistan")
        }

        ListElement {
            key: "58"
            modelData: qsTr("Venezuela")
        }

        ListElement {
            key: "84"
            modelData: qsTr("Vietnam")
        }

        ListElement {
            key: "967"
            modelData: qsTr("Yemen")
        }

        ListElement {
            key: "381"
            modelData: qsTr("Yugoslavia")
        }

        ListElement {
            key: "243"
            modelData: qsTr("Zaire")
        }

        ListElement {
            key: "260"
            modelData: qsTr("Zambia")
        }

        ListElement {
            key: "263"
            modelData: qsTr("Zimbabwe")
        }
    ...
    bdContentItem: Rectangle {
        ...
        function resetBtnSelect() {
            if (serverControl.currentIndex)
                emailBtn.checked = true;
            else if (!serverControl.currentIndex)
                phoneBtn.checked = true;
        }
        ...
        function phoneLoginClicked() {
            ...
            if (showQuickLogin)
                cxkernel_cxcloud.accountService.loginByMobileVerifyCode(account, areaCode, password, globalAutoLogin);
            else
                cxkernel_cxcloud.accountService.loginByMobilePassword(account, areaCode, password, globalAutoLogin);
        }

        function emailLoginClicked() {
            cxkernel_cxcloud.accountService.loginByEmailPassword(idAccountEmailEdit.text, idPasswordEmailEdit.text, globalAutoLogin);
        }
            ...
            Column {
                    ...
                    ComboBox {
                        ...
                        delegate: ItemDelegate {
                            ...
                            contentItem: Rectangle {
                                anchors.fill: parent
                                color: (serverControl.highlightedIndex == index) ? (Constants.currentTheme ? "#C1E8FE" : "#94B2C3") : Constants.currentTheme ? "#FFFFFF" : "#4B4B4D"
                ...
                Row {
                    ...
                    RadioButton {
                        ...
                        width: 120 * screenScaleFactor
                        anchors.verticalCenter: parent.verticalCenter
                        onCheckedChanged: curLoginType = LoginDlg.LoginType.Phone_Type
                    ...
                    RadioButton {
                        ...
                        width: 120 * screenScaleFactor
                        anchors.verticalCenter: parent.verticalCenter
                        onCheckedChanged: curLoginType = LoginDlg.LoginType.Email_Type
                    ...
                    RadioButton {
                        ...
                        anchors.verticalCenter: parent.verticalCenter
                        onCheckedChanged: {
                            curLoginType = LoginDlg.LoginType.Qrcode_Type;
                        }
                ...
                SwipeView {
                    ...
                    interactive: false
                    currentIndex: root.curLoginType - 1
                    onCurrentIndexChanged: {
                        root.txtErrorMsg = "";
                    }
                    ...
                    Item {
                                ...
                                Row {
                                    ...
                                    ComboBox {
                                        ...
                                        delegate: ItemDelegate {
                                            ...
                                            contentItem: Rectangle {
                                                anchors.fill: parent
                                                color: (idAreaCodeCombox.highlightedIndex == index) ? (Constants.currentTheme ? "#C1E8FE" : "#94B2C3") : "transparent"
                                    ...
                                    TextField {
                                        ...
                                        font.pointSize: Constants.labelFontPointSize_9
                                        color: Constants.themeTextColor
                                        onTextChanged: root.txtErrorMsg = ""

                                        validator: RegExpValidator {
                                            regExp: new RegExp(phoneRegExp)
                                        }
                        ...
                        Text {
                            ...
                            font.pointSize: Constants.labelFontPointSize_9
                            color: Constants.themeTextColor
                            text: "<font color='#1CA4F1'>" + (showQuickLogin ? qsTr("Password Login") : qsTr("Instant Login")) + "</font>"
                        ...
                        Text {
                            ...
                            font.pointSize: Constants.labelFontPointSize_9
                            color: Constants.themeTextColor
                            text: "<font color='#1CA4F1'>" + qsTr("Forgot Password?") + "</font>"

                            MouseArea {
                                hoverEnabled: true
                                anchors.fill: parent
                                cursorShape: containsMouse ? Qt.PointingHandCursor : Qt.ArrowCursor
                                onClicked: cxkernel_cxcloud.accountService.resetPassWordWebsitebyPhone()
                            }
                        ...
                        Row {
                            ...
                            Rectangle {
                                ...
                                border.color: Constants.currentTheme ? "#D6D6DC" : "#7A7A7F"
                                color: globalAutoLogin ? "#1E9BE2" : "transparent"
                        ...
                        Row {
                            ...
                            Text {
                                ...
                                font.pointSize: Constants.labelFontPointSize_9
                                color: Constants.themeTextColor
                                text: "<font color='#1CA4F1'>" + qsTr("Create Account") + "</font>"

                                MouseArea {
                                    hoverEnabled: true
                                    anchors.fill: parent
                                    cursorShape: containsMouse ? Qt.PointingHandCursor : Qt.ArrowCursor
                                    onClicked: cxkernel_cxcloud.accountService.signupWebsitebyPhone()
                                }
                    ...
                    Item {
                        ...
                        Text {
                            ...
                            MouseArea {
                                ...
                                anchors.fill: parent
                                cursorShape: containsMouse ? Qt.PointingHandCursor : Qt.ArrowCursor
                                onClicked: cxkernel_cxcloud.accountService.resetPassWordWebsitebyMail()
                            }
                        ...
                        Row {
                            ...
                            Rectangle {
                                ...
                                Image {
                                    ...
                                    source: root.qrsource //"image://login_qrcode_image_provider"
                                }
                            ...
                            Rectangle {
                                ...
                                Text {
                                    ...
                                    color: Constants.themeTextColor
                                    text: qsTr("Me section in app > Scan icon on top") + "<br>" + qsTr("You are browsing") + " " + "<font color='#1CA4F1'>" + qsTr("crealitycloud.cn") + ", " + "</font>" + qsTr("Please use the") + " " + "<font color='#1CA4F1'>" + qsTr("Creality Cloud App (CN version)") + "</font>" + " " + qsTr("to scan the QR code")
                                }
                                ...
                                Text {
                                    ...
                                    lineHeightMode: Text.FixedHeight
                                    color: Constants.themeTextColor
                                    text: qsTr("Me section in app > Scan icon on top") + "<br>" + qsTr("You are browsing") + " " + "<font color='#1CA4F1'>" + qsTr("crealitycloud.com") + ", " + "</font>" + qsTr("Please use the") + " " + "<font color='#1CA4F1'>" + qsTr("Creality Cloud App") + "</font>" + " " + qsTr("to scan the QR code")
                                }
