                    ...
                    Item {
                        ...
                        Row {
                            ...
                            Text {
                                ...
                                font.pointSize: Constants.labelFontPointSize_9
                                color: Constants.themeTextColor
                                text: "<font color='#17CC5F'>" + qsTr("Register") +  "</font>"
                        ...
                        Row {
                            ...
                            Text {
                                ...
                                MouseArea {
                                    ...
                                    anchors.fill: parent
                                    cursorShape: containsMouse ? Qt.PointingHandCursor : Qt.ArrowCursor
                                    onClicked: cxkernel_cxcloud.accountService.signupWebsitebyMail()
                                }
                            }
                        }
                    }
                            ...
                            Rectangle {
                                ...
                                Text {
                                    ...
                                    text: qsTr("Me section in app > Scan icon on top") + "<br>" +
                                          ...
                                          qsTr("Please use the") + " " + "<font color='#1CA17CC5F4F1'>" + qsTr("Creality Cloud App (CN version)") + "</font>" + " " +
