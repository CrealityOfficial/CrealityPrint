...
Item {
    ...
    function setGroupInfo(json_string) {
        ...
        if (json_root.code === 0) {      
            ...
            let user_info = group_info.userInfo
      ...
      //      root.title =  group_info.groupName
            ...
            console.log(group_collect_btn.collectCount, "collectCount")
            ...
            share_group_dialog.setId(group_info.id)
