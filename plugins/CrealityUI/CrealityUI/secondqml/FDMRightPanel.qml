        ...
        Column {
            ...
            Grid {
                ...
                Repeater {
                    ...
                    model: kernel_global_const.customized ? [qsTr("Printing Time") + ": " + printTime, qsTr("Material Weight") + ": " + materialWeight + " g", qsTr("Material Cost") + ": " + materialMoney] : [qsTr("Printing Time") + ": " + printTime, qsTr("Material Weight") + ": " + materialWeight + " g", qsTr("Material Length") + ": " + materialLength.toFixed(2) + " m", qsTr("Material Cost") + ": " + materialMoney]
