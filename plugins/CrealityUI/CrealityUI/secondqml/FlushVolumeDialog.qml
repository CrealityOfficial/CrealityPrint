...
DockItem {
    ...
    title: qsTr("Flushing volumes for filament change")
    ...
    function setTipWarning(){
        for(let i=0;i<tableData.count;i++){
            for(let j=1;j<tableViewContainer.columnCount;j++){
                ...
                if(value>1200 || value<nozzleVolum){
                    tipColor = "red"
                    return;
                }else {
...
//                    width: 100 //parseInt(tableContainer.width/tableData.count)
                ...
                itemDelegate:Rectangle{
                    ...
                    BasicDialogTextField {
                        ...
                        color: (+styleData.value>1200 &&enabled) ?"red":(+styleData.value<nozzleVolum&&enabled)?"red": Constants.themeTextColor
                        anchors.centerIn: parent
        ...
        ColumnLayout{
            ...
            StyledLabel {
                ...
                rightPadding: 10//
                color: tipColor
                text: qsTr("Warm reminder: It is recommended that the flushing volume be set within the range of.")+"("+ nozzleVolum+ "-1200)"
                font.pointSize: Constants.labelFontPointSize_9
            }
        }
