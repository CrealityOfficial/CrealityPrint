...
Window {
  ...
  modality: context == null ? Qt.ApplicationModal : Qt.NonModal
  ...
  Connections {
    ...
    onAdsorbedItemXChanged: {
      x = context.adsorbedItemX
    }

    onAdsorbedItemYChanged: {
      y = context.adsorbedItemY
    }

    onAdsorbedItemWidthChanged: {
      width = context.adsorbedItemWidth
    }

    onAdsorbedItemHeightChanged: {
      height = context.adsorbedItemHeight
    }
  }
  ...
  onAdsorbedChanged: {
    ...
    if (adsorbed) {
      ...
      root.x = context.adsorbedItemX
      root.y = context.adsorbedItemY
      root.width = context.adsorbedItemWidth
      root.height = context.adsorbedItemHeight
    ...
    if (context && context.controller) {
      context.controller.syncContext()
    }
  }
