                        ...
                        background: Item {
                            Row {
                                ...
                                Label {
                                    ...
                                    color: control.checked || control.hovered ? Constants.manager_printer_switch_checked_color : Constants.manager_printer_switch_default_color
                                }
                ...
                GridLayout {
                    ...
                    BasicDialogTextField {
                        ...
                        onTextChanged: {
                            ...
                            var nozzleString = templateComb.currentText.split('_')[0] === "Sermoon D3 Pro" ? nozzle1Comb.currentText + "-" + nozzle2Comb.currentText : nozzle1Comb.currentText;
                ...
                GridLayout {
                    ...
                    BasicDialogTextField {
                        ...
                        onTextChanged: {
                            ...
                            var nozzleString = machineNameTF.text.split('_')[0] === "Sermoon D3 Pro" ? nozzle1bcb.currentText + "-" + nozzle2bcb.currentText : nozzle1bcb.currentText;
                            let isRept = kernel_parameter_manager.isMachineNameRepeat(newPrinterName + '_' + nozzleString);
