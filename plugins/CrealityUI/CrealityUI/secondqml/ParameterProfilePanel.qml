...
DockItem {
    ...
    function startEditProfile(machine, _addOrEdit, extruderCount) {
        ...
        idParameterContext.currentProfile = profileModel;
    ...
    function findTranslate(key) {
        ...
        var tranlateValue = "";
        if (quality === "high")
            tranlateValue = qsTr("High Quality");
        else if (quality === "middle")
            tranlateValue = qsTr("Quality");
        else if (quality === "low")
            tranlateValue = qsTr("Normal");
        else if (quality === "best")
            tranlateValue = qsTr("Best quality");
        else if (quality === "fast")
            tranlateValue = qsTr("Fast");
        else
            tranlateValue = key;
            ...
            Item {
                ...
                RowLayout {
                    ...
                    Settings {
                        ...
                        property bool enabledProfileAdv: false
                    }
                    ...
                    CusSwitchBtn {
                        ...
                        checked: settings.enabledProfileAdv
                        onCheckedChanged: {
                            settings.enabledProfileAdv = idAdvance.checked;
                            updateFilter();
                        }
                    }
