...
DockItem {
    ...
    // temp
    property string currentGroupUid: ""
    onCurrentGroupUidChanged: {
        currentGroupId = currentGroupUid
    }
    ...
    function setGroupInfo(json_string) {
        ...
        if (json_root.code === 0) {
            ...
            if ((group_info.id).localeCompare(currentGroupId) !== 0) return
            ...
            //    id_group_map[currentGroupId].collectionCount = group_info.collectionCount
            ...
            //   id_group_map[currentGroupId].isLike = group_info.isLike
                                ...
                                Image {
                                    ...
                                    MouseArea{
                                        ...
                                        onClicked: {
                                            ...
                                            share_group_dialog.trackTo(group_share_btn)
                                        }
                                    }
                                }
                                Text {
                                ...
                                BasicDialogButton {
                                    ...
                                    onSigButtonClicked: {
                                        ...
                                        if (cxkernel_cxcloud.downloadService.checkModelGroupDownloaded(group_id)) {
                                            ...
                                            cxkernel_cxcloud.downloadService.importModelCache(model_info_list)
