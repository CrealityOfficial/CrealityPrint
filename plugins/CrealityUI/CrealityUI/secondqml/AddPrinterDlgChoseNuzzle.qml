...
BasicDialogV4
{
    ...
    bdContentItem: Rectangle{
        ...
        StackLayout{
            anchors.top: parent.top
            anchors.topMargin: 0 * screenScaleFactor
            anchors.left: parent.left
            anchors.leftMargin: 30 * screenScaleFactor
            ...
            Item{
                ...
                Image{
                    ...
                    source: idAddPrinterDlg.isGranular ? "qrc:/UI/photo/addPrinterSource/extruder1_granular.png"
                                                       : "qrc:/UI/photo/addPrinterSource/extruder1.png"
                ...
                Row{
                    property string nozzleDiameter: nozzleList.model[0]
                    id:nozzleGroup
            ...
            Item{
                ...
                Image{
                    ...
                    anchors.topMargin: 0
                    anchors.horizontalCenter: parent.horizontalCenter
                    source: idAddPrinterDlg.isGranular ? "qrc:/UI/photo/addPrinterSource/extruder2_granular.png"
                                                       : "qrc:/UI/photo/addPrinterSource/extruder2.png"
                    StyledLabel{
                        id: no2_1
