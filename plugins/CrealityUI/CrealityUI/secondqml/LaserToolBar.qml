...
Rectangle {
  ...
  implicitHeight: 255 * screenScaleFactor
    ...
    Rectangle {
      ...
      ColumnLayout {
        ...
        CusImglButton {
          ...
          borderWidth: 0
          btnRadius: root.radius
          cusTooltip.text: qsTr("Rectangle")
          ...
          pressedIconSource: Constants.laserRectCheckedImg
          highLightIconSource: Constants.laserRectHoveredImg
        ...
        CusImglButton {
          ...
          pressedIconSource: Constants.laserArcCheckedImg
          highLightIconSource: Constants.laserArcHoveredImg

          defaultBtnBgColor: Constants.leftBtnBgColor_normal
          hoveredBtnBgColor: Constants.leftBtnBgColor_hovered
          selectedBtnBgColor: Constants.leftBtnBgColor_selected

          onClicked: ellipseMode()
        }
        ...
        CusImglButton {
          ...
          pressedIconSource: Constants.laserFontCheckedImg
          highLightIconSource: Constants.laserFontHoveredImg
