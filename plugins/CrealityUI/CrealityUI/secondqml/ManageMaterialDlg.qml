...
BasicDialogV4 {
    ...
    function startShowMaterialDialog(_state, _extruderIndex, materialName, machineObject) {
        ...
        idParameterContext.settings = material.settingsObject();
        idParameterContext.currentProfile = material.materialParameterModel(extruderIndex);
        itemsModel = idParameterContext.currentProfile;
            ...
            ListView {
                ...
                delegate: RadioButton {
                    ...
                    contentItem: Label {
                        ...
                        color: cbItem.checked || cbItem.hovered ? Constants.manager_printer_switch_checked_color : Constants.manager_printer_switch_default_color
                ...
                Grid {
                    ...
                    Row {
                        BasicDialogTextField {
                            ...
                            validator: null
                            text: currentMachine.materialsName[currentMaterialIndex]
                            onTextChanged: {
                            }
                            onEditingFinished: {
                ...
                CustomTabView {
                    ...
                    Repeater {
                        ...
                        model: ListModel {
                            ...
                            ListElement {
                                labelText: qsTr("Cooling")
                                itemKey: "cooling"
                            }

                            ListElement {
                                labelText: qsTr("Override")
                                itemKey: "override"
                            }

                            ListElement {
                                labelText: qsTr("G-code")
                                itemKey: "gcode"
                            }
