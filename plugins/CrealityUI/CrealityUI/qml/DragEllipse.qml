...
Rectangle {
    ...
    function showWarningColor(hasShow)
    {
        hasError = hasShow
        if(hasShow){
            idEllipse.fillColor = "#FF8080"
        }else{
            idEllipse.fillColor = "#BFD7E4"
        }
    }
    ...
    Shape {
        ...
        ShapePath {
            ...
            PathAngleArc {
                centerX: rectRoi.width/2; centerY: rectRoi.height/2
                radiusX: rectRoi.width/2-2; radiusY: rectRoi.height/2-2
                startAngle: 0
                sweepAngle: 360
            }
        }
